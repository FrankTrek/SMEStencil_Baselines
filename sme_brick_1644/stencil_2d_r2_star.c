void stencil_2d_star_BrickBrick_16164_radius2(float *p0, float *p1, int ker_size_x, int ker_size_y, int ker_size_z, int sy, int sz, int dy, int dz, float *coef)
{
		...
		for(int vy = 0; vy < ker_size_y; vy += 16) {
			...
			if(vec_size_y == 16 && vec_size_z == 4) {
				...
				for(int vx = 0; vx < ker_size_x; vx += 16) {
					...
					ptr_m1 = (buffer_m1 + 224); ptr_0 = buffer_0; ptr_1 = buffer_1;
					// loading from grid 
				...
				mask_x_0 = svwhilelt_b32(0, ker_size_x + 2); 
				mask_z = svdup_b32(0 < ker_size_z - vz); 
				mask_y = svdup_b32(0 < ker_size_y - vy + 2); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(0, 0, mask_xyz, &ptr_src[0 + 0]); 
				mask_y = svdup_b32(1 < ker_size_y - vy + 2); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(0, 1, mask_xyz, &ptr_src[0 + (1*16)]); 
				mask_y = svdup_b32(2 < ker_size_y - vy + 2); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(0, 2, mask_xyz, &ptr_src[0 + (2*16)]); 
				mask_y = svdup_b32(3 < ker_size_y - vy + 2); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(0, 3, mask_xyz, &ptr_src[0 + (3*16)]); 
				mask_y = svdup_b32(4 < ker_size_y - vy + 2); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(0, 4, mask_xyz, &ptr_src[0 + (1*sy)]); 
				mask_y = svdup_b32(5 < ker_size_y - vy + 2); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(0, 5, mask_xyz, &ptr_src[0 + (1*sy+1*16)]); 
				mask_y = svdup_b32(6 < ker_size_y - vy + 2); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(0, 6, mask_xyz, &ptr_src[0 + (1*sy+2*16)]); 
				mask_y = svdup_b32(7 < ker_size_y - vy + 2); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(0, 7, mask_xyz, &ptr_src[0 + (1*sy+3*16)]); 
				mask_y = svdup_b32(8 < ker_size_y - vy + 2); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(0, 8, mask_xyz, &ptr_src[0 + (2*sy)]); 
				mask_y = svdup_b32(9 < ker_size_y - vy + 2); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(0, 9, mask_xyz, &ptr_src[0 + (2*sy+1*16)]); 
				mask_y = svdup_b32(10 < ker_size_y - vy + 2); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(0, 10, mask_xyz, &ptr_src[0 + (2*sy+2*16)]); 
				mask_y = svdup_b32(11 < ker_size_y - vy + 2); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(0, 11, mask_xyz, &ptr_src[0 + (2*sy+3*16)]); 
				mask_y = svdup_b32(12 < ker_size_y - vy + 2); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(0, 12, mask_xyz, &ptr_src[0 + (3*sy)]); 
				mask_y = svdup_b32(13 < ker_size_y - vy + 2); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(0, 13, mask_xyz, &ptr_src[0 + (3*sy+1*16)]); 
				mask_y = svdup_b32(14 < ker_size_y - vy + 2); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(0, 14, mask_xyz, &ptr_src[0 + (3*sy+2*16)]); 
				mask_y = svdup_b32(15 < ker_size_y - vy + 2); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(0, 15, mask_xyz, &ptr_src[0 + (3*sy+3*16)]); 
				mask_z = svdup_b32(1 < ker_size_z - vz); 
				mask_y = svdup_b32(0 < ker_size_y - vy + 2); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(1, 0, mask_xyz, &ptr_src[0 + (1*16*4)]); 
				mask_y = svdup_b32(1 < ker_size_y - vy + 2); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(1, 1, mask_xyz, &ptr_src[0 + (1*16+1*16*4)]); 
				mask_y = svdup_b32(2 < ker_size_y - vy + 2); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(1, 2, mask_xyz, &ptr_src[0 + (2*16+1*16*4)]); 
				mask_y = svdup_b32(3 < ker_size_y - vy + 2); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(1, 3, mask_xyz, &ptr_src[0 + (3*16+1*16*4)]); 
				mask_y = svdup_b32(4 < ker_size_y - vy + 2); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(1, 4, mask_xyz, &ptr_src[0 + (1*sy+1*16*4)]); 
				mask_y = svdup_b32(5 < ker_size_y - vy + 2); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(1, 5, mask_xyz, &ptr_src[0 + (1*sy+1*16+1*16*4)]); 
				mask_y = svdup_b32(6 < ker_size_y - vy + 2); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(1, 6, mask_xyz, &ptr_src[0 + (1*sy+2*16+1*16*4)]); 
				mask_y = svdup_b32(7 < ker_size_y - vy + 2); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(1, 7, mask_xyz, &ptr_src[0 + (1*sy+3*16+1*16*4)]); 
				mask_y = svdup_b32(8 < ker_size_y - vy + 2); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(1, 8, mask_xyz, &ptr_src[0 + (2*sy+1*16*4)]); 
				mask_y = svdup_b32(9 < ker_size_y - vy + 2); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(1, 9, mask_xyz, &ptr_src[0 + (2*sy+1*16+1*16*4)]); 
				mask_y = svdup_b32(10 < ker_size_y - vy + 2); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(1, 10, mask_xyz, &ptr_src[0 + (2*sy+2*16+1*16*4)]); 
				mask_y = svdup_b32(11 < ker_size_y - vy + 2); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(1, 11, mask_xyz, &ptr_src[0 + (2*sy+3*16+1*16*4)]); 
				mask_y = svdup_b32(12 < ker_size_y - vy + 2); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(1, 12, mask_xyz, &ptr_src[0 + (3*sy+1*16*4)]); 
				mask_y = svdup_b32(13 < ker_size_y - vy + 2); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(1, 13, mask_xyz, &ptr_src[0 + (3*sy+1*16+1*16*4)]); 
				mask_y = svdup_b32(14 < ker_size_y - vy + 2); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(1, 14, mask_xyz, &ptr_src[0 + (3*sy+2*16+1*16*4)]); 
				mask_y = svdup_b32(15 < ker_size_y - vy + 2); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(1, 15, mask_xyz, &ptr_src[0 + (3*sy+3*16+1*16*4)]); 
				mask_z = svdup_b32(2 < ker_size_z - vz); 
				mask_y = svdup_b32(0 < ker_size_y - vy + 2); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(2, 0, mask_xyz, &ptr_src[0 + (2*16*4)]); 
				mask_y = svdup_b32(1 < ker_size_y - vy + 2); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(2, 1, mask_xyz, &ptr_src[0 + (1*16+2*16*4)]); 
				mask_y = svdup_b32(2 < ker_size_y - vy + 2); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(2, 2, mask_xyz, &ptr_src[0 + (2*16+2*16*4)]); 
				mask_y = svdup_b32(3 < ker_size_y - vy + 2); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(2, 3, mask_xyz, &ptr_src[0 + (3*16+2*16*4)]); 
				mask_y = svdup_b32(4 < ker_size_y - vy + 2); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(2, 4, mask_xyz, &ptr_src[0 + (1*sy+2*16*4)]); 
				mask_y = svdup_b32(5 < ker_size_y - vy + 2); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(2, 5, mask_xyz, &ptr_src[0 + (1*sy+1*16+2*16*4)]); 
				mask_y = svdup_b32(6 < ker_size_y - vy + 2); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(2, 6, mask_xyz, &ptr_src[0 + (1*sy+2*16+2*16*4)]); 
				mask_y = svdup_b32(7 < ker_size_y - vy + 2); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(2, 7, mask_xyz, &ptr_src[0 + (1*sy+3*16+2*16*4)]); 
				mask_y = svdup_b32(8 < ker_size_y - vy + 2); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(2, 8, mask_xyz, &ptr_src[0 + (2*sy+2*16*4)]); 
				mask_y = svdup_b32(9 < ker_size_y - vy + 2); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(2, 9, mask_xyz, &ptr_src[0 + (2*sy+1*16+2*16*4)]); 
				mask_y = svdup_b32(10 < ker_size_y - vy + 2); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(2, 10, mask_xyz, &ptr_src[0 + (2*sy+2*16+2*16*4)]); 
				mask_y = svdup_b32(11 < ker_size_y - vy + 2); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(2, 11, mask_xyz, &ptr_src[0 + (2*sy+3*16+2*16*4)]); 
				mask_y = svdup_b32(12 < ker_size_y - vy + 2); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(2, 12, mask_xyz, &ptr_src[0 + (3*sy+2*16*4)]); 
				mask_y = svdup_b32(13 < ker_size_y - vy + 2); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(2, 13, mask_xyz, &ptr_src[0 + (3*sy+1*16+2*16*4)]); 
				mask_y = svdup_b32(14 < ker_size_y - vy + 2); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(2, 14, mask_xyz, &ptr_src[0 + (3*sy+2*16+2*16*4)]); 
				mask_y = svdup_b32(15 < ker_size_y - vy + 2); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(2, 15, mask_xyz, &ptr_src[0 + (3*sy+3*16+2*16*4)]); 
				mask_z = svdup_b32(3 < ker_size_z - vz); 
				mask_y = svdup_b32(0 < ker_size_y - vy + 2); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(3, 0, mask_xyz, &ptr_src[0 + (3*16*4)]); 
				mask_y = svdup_b32(1 < ker_size_y - vy + 2); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(3, 1, mask_xyz, &ptr_src[0 + (1*16+3*16*4)]); 
				mask_y = svdup_b32(2 < ker_size_y - vy + 2); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(3, 2, mask_xyz, &ptr_src[0 + (2*16+3*16*4)]); 
				mask_y = svdup_b32(3 < ker_size_y - vy + 2); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(3, 3, mask_xyz, &ptr_src[0 + (3*16+3*16*4)]); 
				mask_y = svdup_b32(4 < ker_size_y - vy + 2); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(3, 4, mask_xyz, &ptr_src[0 + (1*sy+3*16*4)]); 
				mask_y = svdup_b32(5 < ker_size_y - vy + 2); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(3, 5, mask_xyz, &ptr_src[0 + (1*sy+1*16+3*16*4)]); 
				mask_y = svdup_b32(6 < ker_size_y - vy + 2); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(3, 6, mask_xyz, &ptr_src[0 + (1*sy+2*16+3*16*4)]); 
				mask_y = svdup_b32(7 < ker_size_y - vy + 2); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(3, 7, mask_xyz, &ptr_src[0 + (1*sy+3*16+3*16*4)]); 
				mask_y = svdup_b32(8 < ker_size_y - vy + 2); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(3, 8, mask_xyz, &ptr_src[0 + (2*sy+3*16*4)]); 
				mask_y = svdup_b32(9 < ker_size_y - vy + 2); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(3, 9, mask_xyz, &ptr_src[0 + (2*sy+1*16+3*16*4)]); 
				mask_y = svdup_b32(10 < ker_size_y - vy + 2); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(3, 10, mask_xyz, &ptr_src[0 + (2*sy+2*16+3*16*4)]); 
				mask_y = svdup_b32(11 < ker_size_y - vy + 2); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(3, 11, mask_xyz, &ptr_src[0 + (2*sy+3*16+3*16*4)]); 
				mask_y = svdup_b32(12 < ker_size_y - vy + 2); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(3, 12, mask_xyz, &ptr_src[0 + (3*sy+3*16*4)]); 
				mask_y = svdup_b32(13 < ker_size_y - vy + 2); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(3, 13, mask_xyz, &ptr_src[0 + (3*sy+1*16+3*16*4)]); 
				mask_y = svdup_b32(14 < ker_size_y - vy + 2); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(3, 14, mask_xyz, &ptr_src[0 + (3*sy+2*16+3*16*4)]); 
				mask_y = svdup_b32(15 < ker_size_y - vy + 2); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(3, 15, mask_xyz, &ptr_src[0 + (3*sy+3*16+3*16*4)]); 
				//tranpose and store back to grid
				svst1_ver_za32(0, 0, p32_all, &buffer_0[0 + 0]); 
				svst1_ver_za32(0, 1, p32_all, &buffer_0[0 + (1*16)]); 
				svst1_ver_za32(0, 2, p32_all, &buffer_0[0 + (2*16)]); 
