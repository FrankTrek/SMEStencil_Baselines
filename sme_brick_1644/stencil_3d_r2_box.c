void stencil_3d_box_BrickBrick_16164_radius2(float *p0, float *p1, int ker_size_x, int ker_size_y, int ker_size_z, int sy, int sz, int dy, int dz, float *coef)
{
	...
	int k_offset[] = {(-1*sz+2*16*4),(-1*sz+3*16*4),0,(1*16*4),(2*16*4),(3*16*4),(1*sz),(1*sz+1*16*4)};
	int j_offset[] = {(-1*sy+2*16),(-1*sy+3*16),0,(1*16),(2*16),(3*16),(1*sy),(1*sy+1*16),(1*sy+2*16),(1*sy+3*16),(2*sy),(2*sy+1*16),(2*sy+2*16),(2*sy+3*16),(3*sy),(3*sy+1*16),(3*sy+2*16),(3*sy+3*16),(4*sy),(4*sy+1*16)};
			...
			for(int vx = 0; vx < ker_size_x; vx += 16) {
				...
				if(vec_size_y == 16 && vec_size_z == 4) {
					...
					for(int rz = 0; rz < 5; rz += 1) {
						...
						mask_x_1 = svwhilelt_b32(16, ker_size_x - vx + 2 + 16); 
						mask_x_2 = svwhilelt_b32(32, ker_size_x - vx + 2 + 16); 
						mask_ext = svwhilelt_b32(0, 14); mask_ext = sveor_z(p32_all, mask_ext, p32_all); 
						mask_x_0 = svand_z(p32_all, mask_x_0, mask_ext); 
						for(int ry = 0; ry < 5; ry += 1) {
							float* alpha_loc = coef_loc + ry*(2*2 + 1);
							...
							spv000 = svext(iv0_000, iv0_001, 14); svmopa_za32_m(0, p32_all, p32_all, alpha_vec_0, spv000); 
							...
							spv100 = svext(iv1_000, iv1_001, 14); svmopa_za32_m(1, p32_all, p32_all, alpha_vec_0, spv100); 
							...
							spv200 = svext(iv2_000, iv2_001, 14); svmopa_za32_m(2, p32_all, p32_all, alpha_vec_0, spv200); 
							...
							spv300 = svext(iv3_000, iv3_001, 14); svmopa_za32_m(3, p32_all, p32_all, alpha_vec_0, spv300); 
							alpha_vec_1 = svinsr(alpha_vec_1, alpha_loc[1]); 
							spv000 = svext(iv0_000, iv0_001, 15); svmopa_za32_m(0, p32_all, p32_all, alpha_vec_1, spv000); 
							spv100 = svext(iv1_000, iv1_001, 15); svmopa_za32_m(1, p32_all, p32_all, alpha_vec_1, spv100); 
							spv200 = svext(iv2_000, iv2_001, 15); svmopa_za32_m(2, p32_all, p32_all, alpha_vec_1, spv200); 
							spv300 = svext(iv3_000, iv3_001, 15); svmopa_za32_m(3, p32_all, p32_all, alpha_vec_1, spv300); 
							alpha_vec_2 = svinsr(alpha_vec_2, alpha_loc[2]); 
							spv000 = svext(iv0_001, iv0_002, 0); svmopa_za32_m(0, p32_all, p32_all, alpha_vec_2, spv000); 
							spv100 = svext(iv1_001, iv1_002, 0); svmopa_za32_m(1, p32_all, p32_all, alpha_vec_2, spv100); 
							spv200 = svext(iv2_001, iv2_002, 0); svmopa_za32_m(2, p32_all, p32_all, alpha_vec_2, spv200); 
							spv300 = svext(iv3_001, iv3_002, 0); svmopa_za32_m(3, p32_all, p32_all, alpha_vec_2, spv300); 
							alpha_vec_3 = svinsr(alpha_vec_3, alpha_loc[3]); 
							spv000 = svext(iv0_001, iv0_002, 1); svmopa_za32_m(0, p32_all, p32_all, alpha_vec_3, spv000); 
							spv100 = svext(iv1_001, iv1_002, 1); svmopa_za32_m(1, p32_all, p32_all, alpha_vec_3, spv100); 
							spv200 = svext(iv2_001, iv2_002, 1); svmopa_za32_m(2, p32_all, p32_all, alpha_vec_3, spv200); 
							spv300 = svext(iv3_001, iv3_002, 1); svmopa_za32_m(3, p32_all, p32_all, alpha_vec_3, spv300); 
							alpha_vec_4 = svinsr(alpha_vec_4, alpha_loc[4]); 
							spv000 = svext(iv0_001, iv0_002, 2); svmopa_za32_m(0, p32_all, p32_all, alpha_vec_4, spv000); 
							spv100 = svext(iv1_001, iv1_002, 2); svmopa_za32_m(1, p32_all, p32_all, alpha_vec_4, spv100); 
							spv200 = svext(iv2_001, iv2_002, 2); svmopa_za32_m(2, p32_all, p32_all, alpha_vec_4, spv200); 
							spv300 = svext(iv3_001, iv3_002, 2); svmopa_za32_m(3, p32_all, p32_all, alpha_vec_4, spv300); 
						}
						for(int ry = 5; ry < 20; ry += 1) {
