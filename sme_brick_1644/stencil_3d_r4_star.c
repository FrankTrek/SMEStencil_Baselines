void stencil_3d_star_BrickBrick_16164_radius4(float *p0, float *p1, int ker_size_x, int ker_size_y, int ker_size_z, int sy, int sz, int dy, int dz, float *coef)
{
	...
	for(int vz = 0; vz < ker_size_z; vz += 4) {
		for(int vy = 0; vy < ker_size_y; vy += 16) {
			...
			if(vec_size_y == 16 && vec_size_z == 4) {
				...
				ptr_src = (p0 + (((vy)/4)*sy + ((vy)%4)*16+((vz)/4)*sz + ((vz)%4)*16*4)); ptr_dst = (p1 + (((vy)/4)*dy + ((vy)%4)*16+((vz)/4)*dz + ((vz)%4)*16*4)); ptr_l = ptr_src + (-1*sy); ptr_r = ptr_src + (4*sy);
				float buffer[1*(3072) + (1*1024)]__attribute__((aligned(64)));
				float *buffer_m1 = buffer, *buffer_0 = buffer + 1024, *buffer_1 = buffer + 2048;
				mask_ext = svwhilelt_b32(0, 12); mask_ext = sveor_z(p32_all, p32_all, mask_ext); 
				for(int iz = 0; iz < 4; iz += 4) {
					...
					// loading from grid 
					mask_x_0 = svwhilelt_b32(0, ker_size_x + 4); 
				...
				for(int vx = 0; vx < ker_size_x; vx += 16) {
					...
					for(int iz = 0; iz < 4; iz += 4) {
						...
						ptr_m1 = (buffer_m1 + (iz/4)*(3072) + 192); ptr_0 = buffer_0 + (iz/4)*(3072); ptr_1 = buffer_1 + (iz/4)*(3072);
						// loading from grid 
						mask_x_0 = svwhilelt_b32(0, ker_size_x - vx + 4 - 16); 
						...
						sme_input_x0 = svld1(p32_all, &ptr_m1[0 + (2*16)]); svmopa_za32_m(0, p32_all, p32_all, sme_input_x0, alpha_vec_x); 
						sme_input_x1 = svld1(p32_all, &ptr_m1[0 + (2*16+1*16*16)]); svmopa_za32_m(1, p32_all, p32_all, sme_input_x1, alpha_vec_x); 
						sme_input_x2 = svld1(p32_all, &ptr_m1[0 + (2*16+2*16*16)]); svmopa_za32_m(2, p32_all, p32_all, sme_input_x2, alpha_vec_x); 
						sme_input_x3 = svld1(p32_all, &ptr_m1[0 + (2*16+3*16*16)]); svmopa_za32_m(3, p32_all, p32_all, sme_input_x3, alpha_vec_x); 
						// load vector at (-1, 0, 0)
						alpha_vec_x = svinsr(alpha_vec_x, coef[3]); 
						sme_input_x0 = svld1(p32_all, &ptr_m1[0 + (3*16)]); svmopa_za32_m(0, p32_all, p32_all, sme_input_x0, alpha_vec_x); 
						sme_input_x1 = svld1(p32_all, &ptr_m1[0 + (3*16+1*16*16)]); svmopa_za32_m(1, p32_all, p32_all, sme_input_x1, alpha_vec_x); 
						sme_input_x2 = svld1(p32_all, &ptr_m1[0 + (3*16+2*16*16)]); svmopa_za32_m(2, p32_all, p32_all, sme_input_x2, alpha_vec_x); 
						sme_input_x3 = svld1(p32_all, &ptr_m1[0 + (3*16+3*16*16)]); svmopa_za32_m(3, p32_all, p32_all, sme_input_x3, alpha_vec_x); 
						...
						// load vector at (1, 0, 0)
						alpha_vec_x = svinsr(alpha_vec_x, coef[5]); 
						...
						// load vector at (2, 0, 0)
						alpha_vec_x = svinsr(alpha_vec_x, coef[6]); 
						...
						// load vector at (3, 0, 0)
						alpha_vec_x = svinsr(alpha_vec_x, coef[7]); 
						...
						// load vector at (4, 0, 0)
						alpha_vec_x = svinsr(alpha_vec_x, coef[8]); 
						...
						// load vector at (18, 0, 0)
						alpha_vec_x = svinsr(alpha_vec_x, 0); 
						sme_input_x0 = svld1(p32_all, &ptr_1[0 + (2*16)]); svmopa_za32_m(0, p32_all, p32_all, sme_input_x0, alpha_vec_x); 
						sme_input_x1 = svld1(p32_all, &ptr_1[0 + (2*16+1*16*16)]); svmopa_za32_m(1, p32_all, p32_all, sme_input_x1, alpha_vec_x); 
						sme_input_x2 = svld1(p32_all, &ptr_1[0 + (2*16+2*16*16)]); svmopa_za32_m(2, p32_all, p32_all, sme_input_x2, alpha_vec_x); 
						sme_input_x3 = svld1(p32_all, &ptr_1[0 + (2*16+3*16*16)]); svmopa_za32_m(3, p32_all, p32_all, sme_input_x3, alpha_vec_x); 
						// load vector at (19, 0, 0)
						alpha_vec_x = svinsr(alpha_vec_x, 0); 
						sme_input_x0 = svld1(p32_all, &ptr_1[0 + (3*16)]); svmopa_za32_m(0, p32_all, p32_all, sme_input_x0, alpha_vec_x); 
						sme_input_x1 = svld1(p32_all, &ptr_1[0 + (3*16+1*16*16)]); svmopa_za32_m(1, p32_all, p32_all, sme_input_x1, alpha_vec_x); 
						sme_input_x2 = svld1(p32_all, &ptr_1[0 + (3*16+2*16*16)]); svmopa_za32_m(2, p32_all, p32_all, sme_input_x2, alpha_vec_x); 
						sme_input_x3 = svld1(p32_all, &ptr_1[0 + (3*16+3*16*16)]); svmopa_za32_m(3, p32_all, p32_all, sme_input_x3, alpha_vec_x); 
						// declare input vector registers
						svfloat32_t sme_input_y00,sme_input_y10,sme_input_y20,sme_input_y30; 
						// declare input coefficients
						svfloat32_t alpha_vec_y = svdup_f32_x(p32_all, 0); 
						mask_x_0 = svwhilelt_b32(0, ker_size_x - vx + 4); 
						...
						sme_input_y00 = svld1(mask_x_0, &ptr_l[0 + (2*16)]); svmopa_za32_m(0, p32_all, p32_all, alpha_vec_y, sme_input_y00); 
						
						sme_input_y10 = svld1(mask_x_0, &ptr_l[0 + (2*16+1*16*4)]); svmopa_za32_m(1, p32_all, p32_all, alpha_vec_y, sme_input_y10); 
						
						sme_input_y20 = svld1(mask_x_0, &ptr_l[0 + (2*16+2*16*4)]); svmopa_za32_m(2, p32_all, p32_all, alpha_vec_y, sme_input_y20); 
						
						sme_input_y30 = svld1(mask_x_0, &ptr_l[0 + (2*16+3*16*4)]); svmopa_za32_m(3, p32_all, p32_all, alpha_vec_y, sme_input_y30); 
						
						// load vector at (0, -1, 0)
						alpha_vec_y = svinsr(alpha_vec_y, coef[3]); 
						sme_input_y00 = svld1(mask_x_0, &ptr_l[0 + (3*16)]); svmopa_za32_m(0, p32_all, p32_all, alpha_vec_y, sme_input_y00); 
						
						sme_input_y10 = svld1(mask_x_0, &ptr_l[0 + (3*16+1*16*4)]); svmopa_za32_m(1, p32_all, p32_all, alpha_vec_y, sme_input_y10); 
						
						sme_input_y20 = svld1(mask_x_0, &ptr_l[0 + (3*16+2*16*4)]); svmopa_za32_m(2, p32_all, p32_all, alpha_vec_y, sme_input_y20); 
						
						sme_input_y30 = svld1(mask_x_0, &ptr_l[0 + (3*16+3*16*4)]); svmopa_za32_m(3, p32_all, p32_all, alpha_vec_y, sme_input_y30); 
						...
						// load vector at (0, 1, 0)
						alpha_vec_y = svinsr(alpha_vec_y, coef[5]); 
						...
						// load vector at (0, 2, 0)
						alpha_vec_y = svinsr(alpha_vec_y, coef[6]); 
						...
						// load vector at (0, 3, 0)
						alpha_vec_y = svinsr(alpha_vec_y, coef[7]); 
						...
						// load vector at (0, 4, 0)
						alpha_vec_y = svinsr(alpha_vec_y, coef[8]); 
						...
						// load vector at (0, 18, 0)
						alpha_vec_y = svinsr(alpha_vec_y, 0); 
						sme_input_y00 = svld1(mask_x_0, &ptr_r[0 + (2*16)]); svmopa_za32_m(0, p32_all, p32_all, alpha_vec_y, sme_input_y00); 
						
						sme_input_y10 = svld1(mask_x_0, &ptr_r[0 + (2*16+1*16*4)]); svmopa_za32_m(1, p32_all, p32_all, alpha_vec_y, sme_input_y10); 
						
						sme_input_y20 = svld1(mask_x_0, &ptr_r[0 + (2*16+2*16*4)]); svmopa_za32_m(2, p32_all, p32_all, alpha_vec_y, sme_input_y20); 
						
						sme_input_y30 = svld1(mask_x_0, &ptr_r[0 + (2*16+3*16*4)]); svmopa_za32_m(3, p32_all, p32_all, alpha_vec_y, sme_input_y30); 
						
						// load vector at (0, 19, 0)
						alpha_vec_y = svinsr(alpha_vec_y, 0); 
						sme_input_y00 = svld1(mask_x_0, &ptr_r[0 + (3*16)]); svmopa_za32_m(0, p32_all, p32_all, alpha_vec_y, sme_input_y00); 
						
						sme_input_y10 = svld1(mask_x_0, &ptr_r[0 + (3*16+1*16*4)]); svmopa_za32_m(1, p32_all, p32_all, alpha_vec_y, sme_input_y10); 
						
						sme_input_y20 = svld1(mask_x_0, &ptr_r[0 + (3*16+2*16*4)]); svmopa_za32_m(2, p32_all, p32_all, alpha_vec_y, sme_input_y20); 
						
						sme_input_y30 = svld1(mask_x_0, &ptr_r[0 + (3*16+3*16*4)]); svmopa_za32_m(3, p32_all, p32_all, alpha_vec_y, sme_input_y30); 
					...
					for(int iy = 0; iy < 16; iy += 4) {
						...
						// load vector at (0, 0, 1)
						alpha_vec_z = svinsr(alpha_vec_z, coef[5]); 
						...
						// load vector at (0, 0, 2)
						alpha_vec_z = svinsr(alpha_vec_z, coef[6]); 
						...
						// load vector at (0, 0, 3)
						alpha_vec_z = svinsr(alpha_vec_z, coef[7]); 
						...
						// load vector at (0, 0, 4)
						alpha_vec_z = svinsr(alpha_vec_z, coef[8]); 
						sme_input_z00 = svld1(mask_x_0, &ptr_src[0 + (1*sz)]); svmopa_za32_m(0, p32_all, p32_all, alpha_vec_z, sme_input_z00); 
				...
				for(int iz = 0; iz < 4; iz += 4) {
					...
					mask_y = svdup_b32(0 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(0, 0, mask_xyz, &(ptr_src + (iz/4)*((1*sz)) + (-1*16*4*4))[0 + 0]); 
					mask_y = svdup_b32(1 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(0, 1, mask_xyz, &(ptr_src + (iz/4)*((1*sz)) + (-1*16*4*4))[0 + (1*16)]); 
					mask_y = svdup_b32(2 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(0, 2, mask_xyz, &(ptr_src + (iz/4)*((1*sz)) + (-1*16*4*4))[0 + (2*16)]); 
					mask_y = svdup_b32(3 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(0, 3, mask_xyz, &(ptr_src + (iz/4)*((1*sz)) + (-1*16*4*4))[0 + (3*16)]); 
					mask_y = svdup_b32(4 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(0, 4, mask_xyz, &(ptr_src + (iz/4)*((1*sz)) + (-1*16*4*4))[0 + (1*sy)]); 
					mask_y = svdup_b32(5 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(0, 5, mask_xyz, &(ptr_src + (iz/4)*((1*sz)) + (-1*16*4*4))[0 + (1*sy+1*16)]); 
					mask_y = svdup_b32(6 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(0, 6, mask_xyz, &(ptr_src + (iz/4)*((1*sz)) + (-1*16*4*4))[0 + (1*sy+2*16)]); 
					mask_y = svdup_b32(7 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(0, 7, mask_xyz, &(ptr_src + (iz/4)*((1*sz)) + (-1*16*4*4))[0 + (1*sy+3*16)]); 
					mask_y = svdup_b32(8 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(0, 8, mask_xyz, &(ptr_src + (iz/4)*((1*sz)) + (-1*16*4*4))[0 + (2*sy)]); 
					mask_y = svdup_b32(9 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(0, 9, mask_xyz, &(ptr_src + (iz/4)*((1*sz)) + (-1*16*4*4))[0 + (2*sy+1*16)]); 
					mask_y = svdup_b32(10 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(0, 10, mask_xyz, &(ptr_src + (iz/4)*((1*sz)) + (-1*16*4*4))[0 + (2*sy+2*16)]); 
					mask_y = svdup_b32(11 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(0, 11, mask_xyz, &(ptr_src + (iz/4)*((1*sz)) + (-1*16*4*4))[0 + (2*sy+3*16)]); 
					mask_y = svdup_b32(12 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(0, 12, mask_xyz, &(ptr_src + (iz/4)*((1*sz)) + (-1*16*4*4))[0 + (3*sy)]); 
					mask_y = svdup_b32(13 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(0, 13, mask_xyz, &(ptr_src + (iz/4)*((1*sz)) + (-1*16*4*4))[0 + (3*sy+1*16)]); 
					mask_y = svdup_b32(14 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(0, 14, mask_xyz, &(ptr_src + (iz/4)*((1*sz)) + (-1*16*4*4))[0 + (3*sy+2*16)]); 
					mask_y = svdup_b32(15 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(0, 15, mask_xyz, &(ptr_src + (iz/4)*((1*sz)) + (-1*16*4*4))[0 + (3*sy+3*16)]); 
					mask_z = svdup_b32(1 < ker_size_z - vz - iz); 
					mask_y = svdup_b32(0 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(1, 0, mask_xyz, &(ptr_src + (iz/4)*((1*sz)) + (-1*16*4*4))[0 + (1*16*4)]); 
					mask_y = svdup_b32(1 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(1, 1, mask_xyz, &(ptr_src + (iz/4)*((1*sz)) + (-1*16*4*4))[0 + (1*16+1*16*4)]); 
					mask_y = svdup_b32(2 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(1, 2, mask_xyz, &(ptr_src + (iz/4)*((1*sz)) + (-1*16*4*4))[0 + (2*16+1*16*4)]); 
					mask_y = svdup_b32(3 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(1, 3, mask_xyz, &(ptr_src + (iz/4)*((1*sz)) + (-1*16*4*4))[0 + (3*16+1*16*4)]); 
					mask_y = svdup_b32(4 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(1, 4, mask_xyz, &(ptr_src + (iz/4)*((1*sz)) + (-1*16*4*4))[0 + (1*sy+1*16*4)]); 
					mask_y = svdup_b32(5 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(1, 5, mask_xyz, &(ptr_src + (iz/4)*((1*sz)) + (-1*16*4*4))[0 + (1*sy+1*16+1*16*4)]); 
					mask_y = svdup_b32(6 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(1, 6, mask_xyz, &(ptr_src + (iz/4)*((1*sz)) + (-1*16*4*4))[0 + (1*sy+2*16+1*16*4)]); 
					mask_y = svdup_b32(7 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(1, 7, mask_xyz, &(ptr_src + (iz/4)*((1*sz)) + (-1*16*4*4))[0 + (1*sy+3*16+1*16*4)]); 
					mask_y = svdup_b32(8 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(1, 8, mask_xyz, &(ptr_src + (iz/4)*((1*sz)) + (-1*16*4*4))[0 + (2*sy+1*16*4)]); 
					mask_y = svdup_b32(9 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(1, 9, mask_xyz, &(ptr_src + (iz/4)*((1*sz)) + (-1*16*4*4))[0 + (2*sy+1*16+1*16*4)]); 
					mask_y = svdup_b32(10 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(1, 10, mask_xyz, &(ptr_src + (iz/4)*((1*sz)) + (-1*16*4*4))[0 + (2*sy+2*16+1*16*4)]); 
					mask_y = svdup_b32(11 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(1, 11, mask_xyz, &(ptr_src + (iz/4)*((1*sz)) + (-1*16*4*4))[0 + (2*sy+3*16+1*16*4)]); 
					mask_y = svdup_b32(12 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(1, 12, mask_xyz, &(ptr_src + (iz/4)*((1*sz)) + (-1*16*4*4))[0 + (3*sy+1*16*4)]); 
					mask_y = svdup_b32(13 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(1, 13, mask_xyz, &(ptr_src + (iz/4)*((1*sz)) + (-1*16*4*4))[0 + (3*sy+1*16+1*16*4)]); 
					mask_y = svdup_b32(14 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(1, 14, mask_xyz, &(ptr_src + (iz/4)*((1*sz)) + (-1*16*4*4))[0 + (3*sy+2*16+1*16*4)]); 
					mask_y = svdup_b32(15 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(1, 15, mask_xyz, &(ptr_src + (iz/4)*((1*sz)) + (-1*16*4*4))[0 + (3*sy+3*16+1*16*4)]); 
					mask_z = svdup_b32(2 < ker_size_z - vz - iz); 
					mask_y = svdup_b32(0 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(2, 0, mask_xyz, &(ptr_src + (iz/4)*((1*sz)) + (-1*16*4*4))[0 + (2*16*4)]); 
					mask_y = svdup_b32(1 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(2, 1, mask_xyz, &(ptr_src + (iz/4)*((1*sz)) + (-1*16*4*4))[0 + (1*16+2*16*4)]); 
					mask_y = svdup_b32(2 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(2, 2, mask_xyz, &(ptr_src + (iz/4)*((1*sz)) + (-1*16*4*4))[0 + (2*16+2*16*4)]); 
					mask_y = svdup_b32(3 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(2, 3, mask_xyz, &(ptr_src + (iz/4)*((1*sz)) + (-1*16*4*4))[0 + (3*16+2*16*4)]); 
					mask_y = svdup_b32(4 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(2, 4, mask_xyz, &(ptr_src + (iz/4)*((1*sz)) + (-1*16*4*4))[0 + (1*sy+2*16*4)]); 
					mask_y = svdup_b32(5 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(2, 5, mask_xyz, &(ptr_src + (iz/4)*((1*sz)) + (-1*16*4*4))[0 + (1*sy+1*16+2*16*4)]); 
					mask_y = svdup_b32(6 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(2, 6, mask_xyz, &(ptr_src + (iz/4)*((1*sz)) + (-1*16*4*4))[0 + (1*sy+2*16+2*16*4)]); 
					mask_y = svdup_b32(7 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(2, 7, mask_xyz, &(ptr_src + (iz/4)*((1*sz)) + (-1*16*4*4))[0 + (1*sy+3*16+2*16*4)]); 
					mask_y = svdup_b32(8 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(2, 8, mask_xyz, &(ptr_src + (iz/4)*((1*sz)) + (-1*16*4*4))[0 + (2*sy+2*16*4)]); 
					mask_y = svdup_b32(9 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(2, 9, mask_xyz, &(ptr_src + (iz/4)*((1*sz)) + (-1*16*4*4))[0 + (2*sy+1*16+2*16*4)]); 
					mask_y = svdup_b32(10 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(2, 10, mask_xyz, &(ptr_src + (iz/4)*((1*sz)) + (-1*16*4*4))[0 + (2*sy+2*16+2*16*4)]); 
					mask_y = svdup_b32(11 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(2, 11, mask_xyz, &(ptr_src + (iz/4)*((1*sz)) + (-1*16*4*4))[0 + (2*sy+3*16+2*16*4)]); 
					mask_y = svdup_b32(12 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(2, 12, mask_xyz, &(ptr_src + (iz/4)*((1*sz)) + (-1*16*4*4))[0 + (3*sy+2*16*4)]); 
					mask_y = svdup_b32(13 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(2, 13, mask_xyz, &(ptr_src + (iz/4)*((1*sz)) + (-1*16*4*4))[0 + (3*sy+1*16+2*16*4)]); 
					mask_y = svdup_b32(14 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(2, 14, mask_xyz, &(ptr_src + (iz/4)*((1*sz)) + (-1*16*4*4))[0 + (3*sy+2*16+2*16*4)]); 
					mask_y = svdup_b32(15 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(2, 15, mask_xyz, &(ptr_src + (iz/4)*((1*sz)) + (-1*16*4*4))[0 + (3*sy+3*16+2*16*4)]); 
					mask_z = svdup_b32(3 < ker_size_z - vz - iz); 
					mask_y = svdup_b32(0 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(3, 0, mask_xyz, &(ptr_src + (iz/4)*((1*sz)) + (-1*16*4*4))[0 + (3*16*4)]); 
					mask_y = svdup_b32(1 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(3, 1, mask_xyz, &(ptr_src + (iz/4)*((1*sz)) + (-1*16*4*4))[0 + (1*16+3*16*4)]); 
					mask_y = svdup_b32(2 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(3, 2, mask_xyz, &(ptr_src + (iz/4)*((1*sz)) + (-1*16*4*4))[0 + (2*16+3*16*4)]); 
					mask_y = svdup_b32(3 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(3, 3, mask_xyz, &(ptr_src + (iz/4)*((1*sz)) + (-1*16*4*4))[0 + (3*16+3*16*4)]); 
					mask_y = svdup_b32(4 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(3, 4, mask_xyz, &(ptr_src + (iz/4)*((1*sz)) + (-1*16*4*4))[0 + (1*sy+3*16*4)]); 
					mask_y = svdup_b32(5 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(3, 5, mask_xyz, &(ptr_src + (iz/4)*((1*sz)) + (-1*16*4*4))[0 + (1*sy+1*16+3*16*4)]); 
					mask_y = svdup_b32(6 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(3, 6, mask_xyz, &(ptr_src + (iz/4)*((1*sz)) + (-1*16*4*4))[0 + (1*sy+2*16+3*16*4)]); 
					mask_y = svdup_b32(7 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(3, 7, mask_xyz, &(ptr_src + (iz/4)*((1*sz)) + (-1*16*4*4))[0 + (1*sy+3*16+3*16*4)]); 
					mask_y = svdup_b32(8 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(3, 8, mask_xyz, &(ptr_src + (iz/4)*((1*sz)) + (-1*16*4*4))[0 + (2*sy+3*16*4)]); 
					mask_y = svdup_b32(9 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(3, 9, mask_xyz, &(ptr_src + (iz/4)*((1*sz)) + (-1*16*4*4))[0 + (2*sy+1*16+3*16*4)]); 
					mask_y = svdup_b32(10 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(3, 10, mask_xyz, &(ptr_src + (iz/4)*((1*sz)) + (-1*16*4*4))[0 + (2*sy+2*16+3*16*4)]); 
					mask_y = svdup_b32(11 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(3, 11, mask_xyz, &(ptr_src + (iz/4)*((1*sz)) + (-1*16*4*4))[0 + (2*sy+3*16+3*16*4)]); 
					mask_y = svdup_b32(12 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(3, 12, mask_xyz, &(ptr_src + (iz/4)*((1*sz)) + (-1*16*4*4))[0 + (3*sy+3*16*4)]); 
					mask_y = svdup_b32(13 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(3, 13, mask_xyz, &(ptr_src + (iz/4)*((1*sz)) + (-1*16*4*4))[0 + (3*sy+1*16+3*16*4)]); 
					mask_y = svdup_b32(14 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(3, 14, mask_xyz, &(ptr_src + (iz/4)*((1*sz)) + (-1*16*4*4))[0 + (3*sy+2*16+3*16*4)]); 
					mask_y = svdup_b32(15 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(3, 15, mask_xyz, &(ptr_src + (iz/4)*((1*sz)) + (-1*16*4*4))[0 + (3*sy+3*16+3*16*4)]); 
					//tranpose and store back to grid
					svst1_ver_za32(0, 0, p32_all, &(buffer_m1 + (iz/4)*3072)[0 + 0]); 
					svst1_ver_za32(0, 1, p32_all, &(buffer_m1 + (iz/4)*3072)[0 + (1*16)]); 
					svst1_ver_za32(0, 2, p32_all, &(buffer_m1 + (iz/4)*3072)[0 + (2*16)]); 
					...
					mask_x_0 = svwhilelt_b32(0, ker_size_x + 4); 
					mask_z = svdup_b32(0 < ker_size_z - vz - iz); 
					mask_y = svdup_b32(0 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(0, 0, mask_xyz, &(ptr_src + (iz/4)*((1*sz)))[0 + 0]); 
					mask_y = svdup_b32(1 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(0, 1, mask_xyz, &(ptr_src + (iz/4)*((1*sz)))[0 + (1*16)]); 
					mask_y = svdup_b32(2 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(0, 2, mask_xyz, &(ptr_src + (iz/4)*((1*sz)))[0 + (2*16)]); 
					mask_y = svdup_b32(3 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(0, 3, mask_xyz, &(ptr_src + (iz/4)*((1*sz)))[0 + (3*16)]); 
					mask_y = svdup_b32(4 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(0, 4, mask_xyz, &(ptr_src + (iz/4)*((1*sz)))[0 + (1*sy)]); 
					mask_y = svdup_b32(5 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(0, 5, mask_xyz, &(ptr_src + (iz/4)*((1*sz)))[0 + (1*sy+1*16)]); 
					mask_y = svdup_b32(6 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(0, 6, mask_xyz, &(ptr_src + (iz/4)*((1*sz)))[0 + (1*sy+2*16)]); 
					mask_y = svdup_b32(7 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(0, 7, mask_xyz, &(ptr_src + (iz/4)*((1*sz)))[0 + (1*sy+3*16)]); 
					mask_y = svdup_b32(8 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(0, 8, mask_xyz, &(ptr_src + (iz/4)*((1*sz)))[0 + (2*sy)]); 
					mask_y = svdup_b32(9 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(0, 9, mask_xyz, &(ptr_src + (iz/4)*((1*sz)))[0 + (2*sy+1*16)]); 
					mask_y = svdup_b32(10 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(0, 10, mask_xyz, &(ptr_src + (iz/4)*((1*sz)))[0 + (2*sy+2*16)]); 
					mask_y = svdup_b32(11 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(0, 11, mask_xyz, &(ptr_src + (iz/4)*((1*sz)))[0 + (2*sy+3*16)]); 
					mask_y = svdup_b32(12 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(0, 12, mask_xyz, &(ptr_src + (iz/4)*((1*sz)))[0 + (3*sy)]); 
					mask_y = svdup_b32(13 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(0, 13, mask_xyz, &(ptr_src + (iz/4)*((1*sz)))[0 + (3*sy+1*16)]); 
					mask_y = svdup_b32(14 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(0, 14, mask_xyz, &(ptr_src + (iz/4)*((1*sz)))[0 + (3*sy+2*16)]); 
					mask_y = svdup_b32(15 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(0, 15, mask_xyz, &(ptr_src + (iz/4)*((1*sz)))[0 + (3*sy+3*16)]); 
					mask_z = svdup_b32(1 < ker_size_z - vz - iz); 
					mask_y = svdup_b32(0 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(1, 0, mask_xyz, &(ptr_src + (iz/4)*((1*sz)))[0 + (1*16*4)]); 
					mask_y = svdup_b32(1 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(1, 1, mask_xyz, &(ptr_src + (iz/4)*((1*sz)))[0 + (1*16+1*16*4)]); 
					mask_y = svdup_b32(2 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(1, 2, mask_xyz, &(ptr_src + (iz/4)*((1*sz)))[0 + (2*16+1*16*4)]); 
					mask_y = svdup_b32(3 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(1, 3, mask_xyz, &(ptr_src + (iz/4)*((1*sz)))[0 + (3*16+1*16*4)]); 
					mask_y = svdup_b32(4 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(1, 4, mask_xyz, &(ptr_src + (iz/4)*((1*sz)))[0 + (1*sy+1*16*4)]); 
					mask_y = svdup_b32(5 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(1, 5, mask_xyz, &(ptr_src + (iz/4)*((1*sz)))[0 + (1*sy+1*16+1*16*4)]); 
					mask_y = svdup_b32(6 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(1, 6, mask_xyz, &(ptr_src + (iz/4)*((1*sz)))[0 + (1*sy+2*16+1*16*4)]); 
					mask_y = svdup_b32(7 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(1, 7, mask_xyz, &(ptr_src + (iz/4)*((1*sz)))[0 + (1*sy+3*16+1*16*4)]); 
					mask_y = svdup_b32(8 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(1, 8, mask_xyz, &(ptr_src + (iz/4)*((1*sz)))[0 + (2*sy+1*16*4)]); 
					mask_y = svdup_b32(9 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(1, 9, mask_xyz, &(ptr_src + (iz/4)*((1*sz)))[0 + (2*sy+1*16+1*16*4)]); 
					mask_y = svdup_b32(10 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(1, 10, mask_xyz, &(ptr_src + (iz/4)*((1*sz)))[0 + (2*sy+2*16+1*16*4)]); 
					mask_y = svdup_b32(11 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(1, 11, mask_xyz, &(ptr_src + (iz/4)*((1*sz)))[0 + (2*sy+3*16+1*16*4)]); 
					mask_y = svdup_b32(12 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(1, 12, mask_xyz, &(ptr_src + (iz/4)*((1*sz)))[0 + (3*sy+1*16*4)]); 
					mask_y = svdup_b32(13 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(1, 13, mask_xyz, &(ptr_src + (iz/4)*((1*sz)))[0 + (3*sy+1*16+1*16*4)]); 
					mask_y = svdup_b32(14 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(1, 14, mask_xyz, &(ptr_src + (iz/4)*((1*sz)))[0 + (3*sy+2*16+1*16*4)]); 
					mask_y = svdup_b32(15 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(1, 15, mask_xyz, &(ptr_src + (iz/4)*((1*sz)))[0 + (3*sy+3*16+1*16*4)]); 
					mask_z = svdup_b32(2 < ker_size_z - vz - iz); 
					mask_y = svdup_b32(0 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(2, 0, mask_xyz, &(ptr_src + (iz/4)*((1*sz)))[0 + (2*16*4)]); 
					mask_y = svdup_b32(1 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(2, 1, mask_xyz, &(ptr_src + (iz/4)*((1*sz)))[0 + (1*16+2*16*4)]); 
					mask_y = svdup_b32(2 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(2, 2, mask_xyz, &(ptr_src + (iz/4)*((1*sz)))[0 + (2*16+2*16*4)]); 
					mask_y = svdup_b32(3 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(2, 3, mask_xyz, &(ptr_src + (iz/4)*((1*sz)))[0 + (3*16+2*16*4)]); 
					mask_y = svdup_b32(4 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(2, 4, mask_xyz, &(ptr_src + (iz/4)*((1*sz)))[0 + (1*sy+2*16*4)]); 
					mask_y = svdup_b32(5 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(2, 5, mask_xyz, &(ptr_src + (iz/4)*((1*sz)))[0 + (1*sy+1*16+2*16*4)]); 
					mask_y = svdup_b32(6 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(2, 6, mask_xyz, &(ptr_src + (iz/4)*((1*sz)))[0 + (1*sy+2*16+2*16*4)]); 
					mask_y = svdup_b32(7 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(2, 7, mask_xyz, &(ptr_src + (iz/4)*((1*sz)))[0 + (1*sy+3*16+2*16*4)]); 
					mask_y = svdup_b32(8 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(2, 8, mask_xyz, &(ptr_src + (iz/4)*((1*sz)))[0 + (2*sy+2*16*4)]); 
					mask_y = svdup_b32(9 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(2, 9, mask_xyz, &(ptr_src + (iz/4)*((1*sz)))[0 + (2*sy+1*16+2*16*4)]); 
					mask_y = svdup_b32(10 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(2, 10, mask_xyz, &(ptr_src + (iz/4)*((1*sz)))[0 + (2*sy+2*16+2*16*4)]); 
					mask_y = svdup_b32(11 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(2, 11, mask_xyz, &(ptr_src + (iz/4)*((1*sz)))[0 + (2*sy+3*16+2*16*4)]); 
					mask_y = svdup_b32(12 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(2, 12, mask_xyz, &(ptr_src + (iz/4)*((1*sz)))[0 + (3*sy+2*16*4)]); 
					mask_y = svdup_b32(13 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(2, 13, mask_xyz, &(ptr_src + (iz/4)*((1*sz)))[0 + (3*sy+1*16+2*16*4)]); 
					mask_y = svdup_b32(14 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(2, 14, mask_xyz, &(ptr_src + (iz/4)*((1*sz)))[0 + (3*sy+2*16+2*16*4)]); 
					mask_y = svdup_b32(15 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(2, 15, mask_xyz, &(ptr_src + (iz/4)*((1*sz)))[0 + (3*sy+3*16+2*16*4)]); 
					mask_z = svdup_b32(3 < ker_size_z - vz - iz); 
					mask_y = svdup_b32(0 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(3, 0, mask_xyz, &(ptr_src + (iz/4)*((1*sz)))[0 + (3*16*4)]); 
					mask_y = svdup_b32(1 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(3, 1, mask_xyz, &(ptr_src + (iz/4)*((1*sz)))[0 + (1*16+3*16*4)]); 
					mask_y = svdup_b32(2 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(3, 2, mask_xyz, &(ptr_src + (iz/4)*((1*sz)))[0 + (2*16+3*16*4)]); 
					mask_y = svdup_b32(3 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(3, 3, mask_xyz, &(ptr_src + (iz/4)*((1*sz)))[0 + (3*16+3*16*4)]); 
					mask_y = svdup_b32(4 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(3, 4, mask_xyz, &(ptr_src + (iz/4)*((1*sz)))[0 + (1*sy+3*16*4)]); 
					mask_y = svdup_b32(5 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(3, 5, mask_xyz, &(ptr_src + (iz/4)*((1*sz)))[0 + (1*sy+1*16+3*16*4)]); 
					mask_y = svdup_b32(6 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(3, 6, mask_xyz, &(ptr_src + (iz/4)*((1*sz)))[0 + (1*sy+2*16+3*16*4)]); 
					mask_y = svdup_b32(7 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(3, 7, mask_xyz, &(ptr_src + (iz/4)*((1*sz)))[0 + (1*sy+3*16+3*16*4)]); 
					mask_y = svdup_b32(8 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(3, 8, mask_xyz, &(ptr_src + (iz/4)*((1*sz)))[0 + (2*sy+3*16*4)]); 
					mask_y = svdup_b32(9 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(3, 9, mask_xyz, &(ptr_src + (iz/4)*((1*sz)))[0 + (2*sy+1*16+3*16*4)]); 
					mask_y = svdup_b32(10 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(3, 10, mask_xyz, &(ptr_src + (iz/4)*((1*sz)))[0 + (2*sy+2*16+3*16*4)]); 
					mask_y = svdup_b32(11 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(3, 11, mask_xyz, &(ptr_src + (iz/4)*((1*sz)))[0 + (2*sy+3*16+3*16*4)]); 
					mask_y = svdup_b32(12 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(3, 12, mask_xyz, &(ptr_src + (iz/4)*((1*sz)))[0 + (3*sy+3*16*4)]); 
					mask_y = svdup_b32(13 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(3, 13, mask_xyz, &(ptr_src + (iz/4)*((1*sz)))[0 + (3*sy+1*16+3*16*4)]); 
					mask_y = svdup_b32(14 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(3, 14, mask_xyz, &(ptr_src + (iz/4)*((1*sz)))[0 + (3*sy+2*16+3*16*4)]); 
					mask_y = svdup_b32(15 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(3, 15, mask_xyz, &(ptr_src + (iz/4)*((1*sz)))[0 + (3*sy+3*16+3*16*4)]); 
					//tranpose and store back to grid
					svst1_ver_za32(0, 0, p32_all, &(buffer_0 + (iz/4)*3072)[0 + 0]); 
					svst1_ver_za32(0, 1, p32_all, &(buffer_0 + (iz/4)*3072)[0 + (1*16)]); 
					svst1_ver_za32(0, 2, p32_all, &(buffer_0 + (iz/4)*3072)[0 + (2*16)]); 
				...
				for(int vx = 0; vx < ker_size_x; vx += 16) {
					for(int iz = 0; iz < 4; iz += 4) {
						...
						mask_x_0 = svwhilelt_b32(0, ker_size_x - vx + 4 - 16); 
						mask_z = svdup_b32(0 < ker_size_z - vz - iz); 
						mask_y = svdup_b32(0 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(0, 0, mask_xyz, &(ptr_src + (1*16*4*4))[0 + 0]); 
						mask_y = svdup_b32(1 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(0, 1, mask_xyz, &(ptr_src + (1*16*4*4))[0 + (1*16)]); 
						mask_y = svdup_b32(2 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(0, 2, mask_xyz, &(ptr_src + (1*16*4*4))[0 + (2*16)]); 
						mask_y = svdup_b32(3 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(0, 3, mask_xyz, &(ptr_src + (1*16*4*4))[0 + (3*16)]); 
						mask_y = svdup_b32(4 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(0, 4, mask_xyz, &(ptr_src + (1*16*4*4))[0 + (1*sy)]); 
						mask_y = svdup_b32(5 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(0, 5, mask_xyz, &(ptr_src + (1*16*4*4))[0 + (1*sy+1*16)]); 
						mask_y = svdup_b32(6 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(0, 6, mask_xyz, &(ptr_src + (1*16*4*4))[0 + (1*sy+2*16)]); 
						mask_y = svdup_b32(7 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(0, 7, mask_xyz, &(ptr_src + (1*16*4*4))[0 + (1*sy+3*16)]); 
						mask_y = svdup_b32(8 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(0, 8, mask_xyz, &(ptr_src + (1*16*4*4))[0 + (2*sy)]); 
						mask_y = svdup_b32(9 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(0, 9, mask_xyz, &(ptr_src + (1*16*4*4))[0 + (2*sy+1*16)]); 
						mask_y = svdup_b32(10 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(0, 10, mask_xyz, &(ptr_src + (1*16*4*4))[0 + (2*sy+2*16)]); 
						mask_y = svdup_b32(11 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(0, 11, mask_xyz, &(ptr_src + (1*16*4*4))[0 + (2*sy+3*16)]); 
						mask_y = svdup_b32(12 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(0, 12, mask_xyz, &(ptr_src + (1*16*4*4))[0 + (3*sy)]); 
						mask_y = svdup_b32(13 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(0, 13, mask_xyz, &(ptr_src + (1*16*4*4))[0 + (3*sy+1*16)]); 
						mask_y = svdup_b32(14 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(0, 14, mask_xyz, &(ptr_src + (1*16*4*4))[0 + (3*sy+2*16)]); 
						mask_y = svdup_b32(15 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(0, 15, mask_xyz, &(ptr_src + (1*16*4*4))[0 + (3*sy+3*16)]); 
						mask_z = svdup_b32(1 < ker_size_z - vz - iz); 
						mask_y = svdup_b32(0 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(1, 0, mask_xyz, &(ptr_src + (1*16*4*4))[0 + (1*16*4)]); 
						mask_y = svdup_b32(1 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(1, 1, mask_xyz, &(ptr_src + (1*16*4*4))[0 + (1*16+1*16*4)]); 
						mask_y = svdup_b32(2 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(1, 2, mask_xyz, &(ptr_src + (1*16*4*4))[0 + (2*16+1*16*4)]); 
						mask_y = svdup_b32(3 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(1, 3, mask_xyz, &(ptr_src + (1*16*4*4))[0 + (3*16+1*16*4)]); 
						mask_y = svdup_b32(4 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(1, 4, mask_xyz, &(ptr_src + (1*16*4*4))[0 + (1*sy+1*16*4)]); 
						mask_y = svdup_b32(5 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(1, 5, mask_xyz, &(ptr_src + (1*16*4*4))[0 + (1*sy+1*16+1*16*4)]); 
						mask_y = svdup_b32(6 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(1, 6, mask_xyz, &(ptr_src + (1*16*4*4))[0 + (1*sy+2*16+1*16*4)]); 
						mask_y = svdup_b32(7 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(1, 7, mask_xyz, &(ptr_src + (1*16*4*4))[0 + (1*sy+3*16+1*16*4)]); 
						mask_y = svdup_b32(8 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(1, 8, mask_xyz, &(ptr_src + (1*16*4*4))[0 + (2*sy+1*16*4)]); 
						mask_y = svdup_b32(9 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(1, 9, mask_xyz, &(ptr_src + (1*16*4*4))[0 + (2*sy+1*16+1*16*4)]); 
						mask_y = svdup_b32(10 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(1, 10, mask_xyz, &(ptr_src + (1*16*4*4))[0 + (2*sy+2*16+1*16*4)]); 
						mask_y = svdup_b32(11 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(1, 11, mask_xyz, &(ptr_src + (1*16*4*4))[0 + (2*sy+3*16+1*16*4)]); 
						mask_y = svdup_b32(12 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(1, 12, mask_xyz, &(ptr_src + (1*16*4*4))[0 + (3*sy+1*16*4)]); 
						mask_y = svdup_b32(13 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(1, 13, mask_xyz, &(ptr_src + (1*16*4*4))[0 + (3*sy+1*16+1*16*4)]); 
						mask_y = svdup_b32(14 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(1, 14, mask_xyz, &(ptr_src + (1*16*4*4))[0 + (3*sy+2*16+1*16*4)]); 
						mask_y = svdup_b32(15 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(1, 15, mask_xyz, &(ptr_src + (1*16*4*4))[0 + (3*sy+3*16+1*16*4)]); 
						mask_z = svdup_b32(2 < ker_size_z - vz - iz); 
						mask_y = svdup_b32(0 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(2, 0, mask_xyz, &(ptr_src + (1*16*4*4))[0 + (2*16*4)]); 
						mask_y = svdup_b32(1 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(2, 1, mask_xyz, &(ptr_src + (1*16*4*4))[0 + (1*16+2*16*4)]); 
						mask_y = svdup_b32(2 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(2, 2, mask_xyz, &(ptr_src + (1*16*4*4))[0 + (2*16+2*16*4)]); 
						mask_y = svdup_b32(3 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(2, 3, mask_xyz, &(ptr_src + (1*16*4*4))[0 + (3*16+2*16*4)]); 
						mask_y = svdup_b32(4 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(2, 4, mask_xyz, &(ptr_src + (1*16*4*4))[0 + (1*sy+2*16*4)]); 
						mask_y = svdup_b32(5 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(2, 5, mask_xyz, &(ptr_src + (1*16*4*4))[0 + (1*sy+1*16+2*16*4)]); 
						mask_y = svdup_b32(6 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(2, 6, mask_xyz, &(ptr_src + (1*16*4*4))[0 + (1*sy+2*16+2*16*4)]); 
						mask_y = svdup_b32(7 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(2, 7, mask_xyz, &(ptr_src + (1*16*4*4))[0 + (1*sy+3*16+2*16*4)]); 
						mask_y = svdup_b32(8 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(2, 8, mask_xyz, &(ptr_src + (1*16*4*4))[0 + (2*sy+2*16*4)]); 
						mask_y = svdup_b32(9 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(2, 9, mask_xyz, &(ptr_src + (1*16*4*4))[0 + (2*sy+1*16+2*16*4)]); 
						mask_y = svdup_b32(10 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(2, 10, mask_xyz, &(ptr_src + (1*16*4*4))[0 + (2*sy+2*16+2*16*4)]); 
						mask_y = svdup_b32(11 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(2, 11, mask_xyz, &(ptr_src + (1*16*4*4))[0 + (2*sy+3*16+2*16*4)]); 
						mask_y = svdup_b32(12 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(2, 12, mask_xyz, &(ptr_src + (1*16*4*4))[0 + (3*sy+2*16*4)]); 
						mask_y = svdup_b32(13 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(2, 13, mask_xyz, &(ptr_src + (1*16*4*4))[0 + (3*sy+1*16+2*16*4)]); 
						mask_y = svdup_b32(14 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(2, 14, mask_xyz, &(ptr_src + (1*16*4*4))[0 + (3*sy+2*16+2*16*4)]); 
						mask_y = svdup_b32(15 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(2, 15, mask_xyz, &(ptr_src + (1*16*4*4))[0 + (3*sy+3*16+2*16*4)]); 
						mask_z = svdup_b32(3 < ker_size_z - vz - iz); 
						mask_y = svdup_b32(0 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(3, 0, mask_xyz, &(ptr_src + (1*16*4*4))[0 + (3*16*4)]); 
						mask_y = svdup_b32(1 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(3, 1, mask_xyz, &(ptr_src + (1*16*4*4))[0 + (1*16+3*16*4)]); 
						mask_y = svdup_b32(2 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(3, 2, mask_xyz, &(ptr_src + (1*16*4*4))[0 + (2*16+3*16*4)]); 
						mask_y = svdup_b32(3 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(3, 3, mask_xyz, &(ptr_src + (1*16*4*4))[0 + (3*16+3*16*4)]); 
						mask_y = svdup_b32(4 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(3, 4, mask_xyz, &(ptr_src + (1*16*4*4))[0 + (1*sy+3*16*4)]); 
						mask_y = svdup_b32(5 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(3, 5, mask_xyz, &(ptr_src + (1*16*4*4))[0 + (1*sy+1*16+3*16*4)]); 
						mask_y = svdup_b32(6 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(3, 6, mask_xyz, &(ptr_src + (1*16*4*4))[0 + (1*sy+2*16+3*16*4)]); 
						mask_y = svdup_b32(7 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(3, 7, mask_xyz, &(ptr_src + (1*16*4*4))[0 + (1*sy+3*16+3*16*4)]); 
						mask_y = svdup_b32(8 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(3, 8, mask_xyz, &(ptr_src + (1*16*4*4))[0 + (2*sy+3*16*4)]); 
						mask_y = svdup_b32(9 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(3, 9, mask_xyz, &(ptr_src + (1*16*4*4))[0 + (2*sy+1*16+3*16*4)]); 
						mask_y = svdup_b32(10 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(3, 10, mask_xyz, &(ptr_src + (1*16*4*4))[0 + (2*sy+2*16+3*16*4)]); 
						mask_y = svdup_b32(11 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(3, 11, mask_xyz, &(ptr_src + (1*16*4*4))[0 + (2*sy+3*16+3*16*4)]); 
						mask_y = svdup_b32(12 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(3, 12, mask_xyz, &(ptr_src + (1*16*4*4))[0 + (3*sy+3*16*4)]); 
						mask_y = svdup_b32(13 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(3, 13, mask_xyz, &(ptr_src + (1*16*4*4))[0 + (3*sy+1*16+3*16*4)]); 
						mask_y = svdup_b32(14 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(3, 14, mask_xyz, &(ptr_src + (1*16*4*4))[0 + (3*sy+2*16+3*16*4)]); 
						mask_y = svdup_b32(15 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(3, 15, mask_xyz, &(ptr_src + (1*16*4*4))[0 + (3*sy+3*16+3*16*4)]); 
						//tranpose and store back to grid
						svst1_ver_za32(0, 0, p32_all, &ptr_1[0 + 0]); 
						svst1_ver_za32(0, 1, p32_all, &ptr_1[0 + (1*16)]); 
						svst1_ver_za32(0, 2, p32_all, &ptr_1[0 + (2*16)]); 
						...
						mask_x_0 = svwhilelt_b32(0, ker_size_x - vx + 4); 
						// load vector at (0, -4, 0)
						mask_y = svdup_b32(-4 < ker_size_y - vy + 4); 
						alpha_vec_y = svinsr(alpha_vec_y, coef[0]); 
						...
						// load vector at (0, -3, 0)
						mask_y = svdup_b32(-3 < ker_size_y - vy + 4); 
						alpha_vec_y = svinsr(alpha_vec_y, coef[1]); 
						mask_z = svdup_b32(0 < ker_size_z - vz - iz); mask_yz = svand_z(p32_all, mask_z, mask_y); 
						...
						// load vector at (0, -2, 0)
						mask_y = svdup_b32(-2 < ker_size_y - vy + 4); 
						alpha_vec_y = svinsr(alpha_vec_y, coef[2]); 
						mask_z = svdup_b32(0 < ker_size_z - vz - iz); mask_yz = svand_z(p32_all, mask_z, mask_y); 
						mask_xyz = svand_z(p32_all, mask_yz, mask_x_0); sme_input_y00 = svld1(mask_xyz, &ptr_l[0 + (2*16)]); svmopa_za32_m(0, p32_all, p32_all, alpha_vec_y, sme_input_y00); 
						
						mask_z = svdup_b32(1 < ker_size_z - vz - iz); mask_yz = svand_z(p32_all, mask_z, mask_y); 
						mask_xyz = svand_z(p32_all, mask_yz, mask_x_0); sme_input_y10 = svld1(mask_xyz, &ptr_l[0 + (2*16+1*16*4)]); svmopa_za32_m(1, p32_all, p32_all, alpha_vec_y, sme_input_y10); 
						
						mask_z = svdup_b32(2 < ker_size_z - vz - iz); mask_yz = svand_z(p32_all, mask_z, mask_y); 
						mask_xyz = svand_z(p32_all, mask_yz, mask_x_0); sme_input_y20 = svld1(mask_xyz, &ptr_l[0 + (2*16+2*16*4)]); svmopa_za32_m(2, p32_all, p32_all, alpha_vec_y, sme_input_y20); 
						
						mask_z = svdup_b32(3 < ker_size_z - vz - iz); mask_yz = svand_z(p32_all, mask_z, mask_y); 
						mask_xyz = svand_z(p32_all, mask_yz, mask_x_0); sme_input_y30 = svld1(mask_xyz, &ptr_l[0 + (2*16+3*16*4)]); svmopa_za32_m(3, p32_all, p32_all, alpha_vec_y, sme_input_y30); 
						
						// load vector at (0, -1, 0)
						mask_y = svdup_b32(-1 < ker_size_y - vy + 4); 
						alpha_vec_y = svinsr(alpha_vec_y, coef[3]); 
						mask_z = svdup_b32(0 < ker_size_z - vz - iz); mask_yz = svand_z(p32_all, mask_z, mask_y); 
						mask_xyz = svand_z(p32_all, mask_yz, mask_x_0); sme_input_y00 = svld1(mask_xyz, &ptr_l[0 + (3*16)]); svmopa_za32_m(0, p32_all, p32_all, alpha_vec_y, sme_input_y00); 
						
						mask_z = svdup_b32(1 < ker_size_z - vz - iz); mask_yz = svand_z(p32_all, mask_z, mask_y); 
						mask_xyz = svand_z(p32_all, mask_yz, mask_x_0); sme_input_y10 = svld1(mask_xyz, &ptr_l[0 + (3*16+1*16*4)]); svmopa_za32_m(1, p32_all, p32_all, alpha_vec_y, sme_input_y10); 
						
						mask_z = svdup_b32(2 < ker_size_z - vz - iz); mask_yz = svand_z(p32_all, mask_z, mask_y); 
						mask_xyz = svand_z(p32_all, mask_yz, mask_x_0); sme_input_y20 = svld1(mask_xyz, &ptr_l[0 + (3*16+2*16*4)]); svmopa_za32_m(2, p32_all, p32_all, alpha_vec_y, sme_input_y20); 
						
						mask_z = svdup_b32(3 < ker_size_z - vz - iz); mask_yz = svand_z(p32_all, mask_z, mask_y); 
						mask_xyz = svand_z(p32_all, mask_yz, mask_x_0); sme_input_y30 = svld1(mask_xyz, &ptr_l[0 + (3*16+3*16*4)]); svmopa_za32_m(3, p32_all, p32_all, alpha_vec_y, sme_input_y30); 
						
						// load vector at (0, 0, 0)
						mask_y = svdup_b32(0 < ker_size_y - vy + 4); 
						alpha_vec_y = svinsr(alpha_vec_y, coef[4]); 
						mask_z = svdup_b32(0 < ker_size_z - vz - iz); mask_yz = svand_z(p32_all, mask_z, mask_y); 
						...
						// load vector at (0, 5, 0)
						mask_y = svdup_b32(5 < ker_size_y - vy + 4); 
						alpha_vec_y = svinsr(alpha_vec_y, 0); 
						mask_z = svdup_b32(0 < ker_size_z - vz - iz); mask_yz = svand_z(p32_all, mask_z, mask_y); 
						...
						// load vector at (0, 6, 0)
						mask_y = svdup_b32(6 < ker_size_y - vy + 4); 
						alpha_vec_y = svinsr(alpha_vec_y, 0); 
						mask_z = svdup_b32(0 < ker_size_z - vz - iz); mask_yz = svand_z(p32_all, mask_z, mask_y); 
						...
						// load vector at (0, 7, 0)
						mask_y = svdup_b32(7 < ker_size_y - vy + 4); 
						alpha_vec_y = svinsr(alpha_vec_y, 0); 
						mask_z = svdup_b32(0 < ker_size_z - vz - iz); mask_yz = svand_z(p32_all, mask_z, mask_y); 
						...
						// load vector at (0, 8, 0)
						mask_y = svdup_b32(8 < ker_size_y - vy + 4); 
						alpha_vec_y = svinsr(alpha_vec_y, 0); 
						mask_z = svdup_b32(0 < ker_size_z - vz - iz); mask_yz = svand_z(p32_all, mask_z, mask_y); 
						...
						// load vector at (0, 9, 0)
						mask_y = svdup_b32(9 < ker_size_y - vy + 4); 
						alpha_vec_y = svinsr(alpha_vec_y, 0); 
						mask_z = svdup_b32(0 < ker_size_z - vz - iz); mask_yz = svand_z(p32_all, mask_z, mask_y); 
						...
						// load vector at (0, 10, 0)
						mask_y = svdup_b32(10 < ker_size_y - vy + 4); 
						alpha_vec_y = svinsr(alpha_vec_y, 0); 
						mask_z = svdup_b32(0 < ker_size_z - vz - iz); mask_yz = svand_z(p32_all, mask_z, mask_y); 
						...
						// load vector at (0, 11, 0)
						mask_y = svdup_b32(11 < ker_size_y - vy + 4); 
						alpha_vec_y = svinsr(alpha_vec_y, 0); 
						mask_z = svdup_b32(0 < ker_size_z - vz - iz); mask_yz = svand_z(p32_all, mask_z, mask_y); 
						...
						// load vector at (0, 12, 0)
						mask_y = svdup_b32(12 < ker_size_y - vy + 4); 
						alpha_vec_y = svinsr(alpha_vec_y, 0); 
						mask_z = svdup_b32(0 < ker_size_z - vz - iz); mask_yz = svand_z(p32_all, mask_z, mask_y); 
						...
						// load vector at (0, 13, 0)
						mask_y = svdup_b32(13 < ker_size_y - vy + 4); 
						alpha_vec_y = svinsr(alpha_vec_y, 0); 
						mask_z = svdup_b32(0 < ker_size_z - vz - iz); mask_yz = svand_z(p32_all, mask_z, mask_y); 
						...
						// load vector at (0, 14, 0)
						mask_y = svdup_b32(14 < ker_size_y - vy + 4); 
						alpha_vec_y = svinsr(alpha_vec_y, 0); 
						mask_z = svdup_b32(0 < ker_size_z - vz - iz); mask_yz = svand_z(p32_all, mask_z, mask_y); 
						...
						// load vector at (0, 15, 0)
						mask_y = svdup_b32(15 < ker_size_y - vy + 4); 
						alpha_vec_y = svinsr(alpha_vec_y, 0); 
						mask_z = svdup_b32(0 < ker_size_z - vz - iz); mask_yz = svand_z(p32_all, mask_z, mask_y); 
						...
						// load vector at (0, 16, 0)
						mask_y = svdup_b32(16 < ker_size_y - vy + 4); 
						alpha_vec_y = svinsr(alpha_vec_y, 0); 
						mask_z = svdup_b32(0 < ker_size_z - vz - iz); mask_yz = svand_z(p32_all, mask_z, mask_y); 
						...
						// load vector at (0, 17, 0)
						mask_y = svdup_b32(17 < ker_size_y - vy + 4); 
						alpha_vec_y = svinsr(alpha_vec_y, 0); 
						mask_z = svdup_b32(0 < ker_size_z - vz - iz); mask_yz = svand_z(p32_all, mask_z, mask_y); 
						...
						// load vector at (0, 18, 0)
						mask_y = svdup_b32(18 < ker_size_y - vy + 4); 
						alpha_vec_y = svinsr(alpha_vec_y, 0); 
						mask_z = svdup_b32(0 < ker_size_z - vz - iz); mask_yz = svand_z(p32_all, mask_z, mask_y); 
						mask_xyz = svand_z(p32_all, mask_yz, mask_x_0); sme_input_y00 = svld1(mask_xyz, &ptr_r[0 + (2*16)]); svmopa_za32_m(0, p32_all, p32_all, alpha_vec_y, sme_input_y00); 
						
						mask_z = svdup_b32(1 < ker_size_z - vz - iz); mask_yz = svand_z(p32_all, mask_z, mask_y); 
						mask_xyz = svand_z(p32_all, mask_yz, mask_x_0); sme_input_y10 = svld1(mask_xyz, &ptr_r[0 + (2*16+1*16*4)]); svmopa_za32_m(1, p32_all, p32_all, alpha_vec_y, sme_input_y10); 
						
						mask_z = svdup_b32(2 < ker_size_z - vz - iz); mask_yz = svand_z(p32_all, mask_z, mask_y); 
						mask_xyz = svand_z(p32_all, mask_yz, mask_x_0); sme_input_y20 = svld1(mask_xyz, &ptr_r[0 + (2*16+2*16*4)]); svmopa_za32_m(2, p32_all, p32_all, alpha_vec_y, sme_input_y20); 
						
						mask_z = svdup_b32(3 < ker_size_z - vz - iz); mask_yz = svand_z(p32_all, mask_z, mask_y); 
						mask_xyz = svand_z(p32_all, mask_yz, mask_x_0); sme_input_y30 = svld1(mask_xyz, &ptr_r[0 + (2*16+3*16*4)]); svmopa_za32_m(3, p32_all, p32_all, alpha_vec_y, sme_input_y30); 
						
						// load vector at (0, 19, 0)
						mask_y = svdup_b32(19 < ker_size_y - vy + 4); 
						alpha_vec_y = svinsr(alpha_vec_y, 0); 
						mask_z = svdup_b32(0 < ker_size_z - vz - iz); mask_yz = svand_z(p32_all, mask_z, mask_y); 
						mask_xyz = svand_z(p32_all, mask_yz, mask_x_0); sme_input_y00 = svld1(mask_xyz, &ptr_r[0 + (3*16)]); svmopa_za32_m(0, p32_all, p32_all, alpha_vec_y, sme_input_y00); 
						
						mask_z = svdup_b32(1 < ker_size_z - vz - iz); mask_yz = svand_z(p32_all, mask_z, mask_y); 
						mask_xyz = svand_z(p32_all, mask_yz, mask_x_0); sme_input_y10 = svld1(mask_xyz, &ptr_r[0 + (3*16+1*16*4)]); svmopa_za32_m(1, p32_all, p32_all, alpha_vec_y, sme_input_y10); 
						
						mask_z = svdup_b32(2 < ker_size_z - vz - iz); mask_yz = svand_z(p32_all, mask_z, mask_y); 
						mask_xyz = svand_z(p32_all, mask_yz, mask_x_0); sme_input_y20 = svld1(mask_xyz, &ptr_r[0 + (3*16+2*16*4)]); svmopa_za32_m(2, p32_all, p32_all, alpha_vec_y, sme_input_y20); 
						
						mask_z = svdup_b32(3 < ker_size_z - vz - iz); mask_yz = svand_z(p32_all, mask_z, mask_y); 
						mask_xyz = svand_z(p32_all, mask_yz, mask_x_0); sme_input_y30 = svld1(mask_xyz, &ptr_r[0 + (3*16+3*16*4)]); svmopa_za32_m(3, p32_all, p32_all, alpha_vec_y, sme_input_y30); 
					...
					for(int iy = 0; iy < 16; iy += 4) {
						...
						mask_x_0 = svwhilelt_b32(0, ker_size_x - vx); 
						// load vector at (0, 0, -4)
						mask_z = svdup_b32(-4 < ker_size_z - vz + 4); 
						alpha_vec_z = svinsr(alpha_vec_z, coef[0]); 
						...
						// load vector at (0, 0, -3)
						mask_z = svdup_b32(-3 < ker_size_z - vz + 4); 
						alpha_vec_z = svinsr(alpha_vec_z, coef[1]); 
						mask_y = svdup_b32(0 < ker_size_y - vy - iy); mask_yz = svand_z(p32_all, mask_y, mask_z); 
						...
						// load vector at (0, 0, -2)
						mask_z = svdup_b32(-2 < ker_size_z - vz + 4); 
						alpha_vec_z = svinsr(alpha_vec_z, coef[2]); 
						mask_y = svdup_b32(0 < ker_size_y - vy - iy); mask_yz = svand_z(p32_all, mask_y, mask_z); 
						...
						// load vector at (0, 0, -1)
						mask_z = svdup_b32(-1 < ker_size_z - vz + 4); 
						alpha_vec_z = svinsr(alpha_vec_z, coef[3]); 
						mask_y = svdup_b32(0 < ker_size_y - vy - iy); mask_yz = svand_z(p32_all, mask_y, mask_z); 
						...
						// load vector at (0, 0, 0)
						mask_z = svdup_b32(0 < ker_size_z - vz + 4); 
						alpha_vec_z = svinsr(alpha_vec_z, coef[4]); 
						mask_y = svdup_b32(0 < ker_size_y - vy - iy); mask_yz = svand_z(p32_all, mask_y, mask_z); 
						...
						// load vector at (0, 0, 5)
						mask_z = svdup_b32(5 < ker_size_z - vz + 4); 
						alpha_vec_z = svinsr(alpha_vec_z, 0); 
						mask_y = svdup_b32(0 < ker_size_y - vy - iy); mask_yz = svand_z(p32_all, mask_y, mask_z); 
						mask_xyz = svand_z(p32_all, mask_yz, mask_x_0); sme_input_z00 = svld1(mask_xyz, &ptr_src[0 + (1*sz+1*16*4)]); svmopa_za32_m(0, p32_all, p32_all, alpha_vec_z, sme_input_z00); 
						...
						// load vector at (0, 0, 6)
						mask_z = svdup_b32(6 < ker_size_z - vz + 4); 
						alpha_vec_z = svinsr(alpha_vec_z, 0); 
						mask_y = svdup_b32(0 < ker_size_y - vy - iy); mask_yz = svand_z(p32_all, mask_y, mask_z); 
						mask_xyz = svand_z(p32_all, mask_yz, mask_x_0); sme_input_z00 = svld1(mask_xyz, &ptr_src[0 + (1*sz+2*16*4)]); svmopa_za32_m(0, p32_all, p32_all, alpha_vec_z, sme_input_z00); 
						...
						// load vector at (0, 0, 7)
						mask_z = svdup_b32(7 < ker_size_z - vz + 4); 
						alpha_vec_z = svinsr(alpha_vec_z, 0); 
						mask_y = svdup_b32(0 < ker_size_y - vy - iy); mask_yz = svand_z(p32_all, mask_y, mask_z); 
						mask_xyz = svand_z(p32_all, mask_yz, mask_x_0); sme_input_z00 = svld1(mask_xyz, &ptr_src[0 + (1*sz+3*16*4)]); svmopa_za32_m(0, p32_all, p32_all, alpha_vec_z, sme_input_z00); 
