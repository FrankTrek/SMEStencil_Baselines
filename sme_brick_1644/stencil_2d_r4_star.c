void stencil_2d_star_BrickBrick_16164_radius4(float *p0, float *p1, int ker_size_x, int ker_size_y, int ker_size_z, int sy, int sz, int dy, int dz, float *coef)
{
	...
	for(int vz = 0; vz < ker_size_z; vz += 4) {
		for(int vy = 0; vy < ker_size_y; vy += 16) {
			...
			if(vec_size_y == 16 && vec_size_z == 4) {
				...
				float buffer[3072]__attribute__((aligned(64)));
				...
				svst1_ver_za32(0, 0, p32_all, &buffer_m1[0 + 0]); 
				svst1_ver_za32(0, 1, p32_all, &buffer_m1[0 + (1*16)]); 
				svst1_ver_za32(0, 2, p32_all, &buffer_m1[0 + (2*16)]); 
				svst1_ver_za32(0, 3, p32_all, &buffer_m1[0 + (3*16)]); 
				svst1_ver_za32(0, 4, p32_all, &buffer_m1[0 + (4*16)]); 
				svst1_ver_za32(0, 5, p32_all, &buffer_m1[0 + (5*16)]); 
				svst1_ver_za32(0, 6, p32_all, &buffer_m1[0 + (6*16)]); 
				svst1_ver_za32(0, 7, p32_all, &buffer_m1[0 + (7*16)]); 
				svst1_ver_za32(0, 8, p32_all, &buffer_m1[0 + (8*16)]); 
				svst1_ver_za32(0, 9, p32_all, &buffer_m1[0 + (9*16)]); 
				svst1_ver_za32(0, 10, p32_all, &buffer_m1[0 + (10*16)]); 
				svst1_ver_za32(0, 11, p32_all, &buffer_m1[0 + (11*16)]); 
				svst1_ver_za32(0, 12, p32_all, &buffer_m1[0 + (12*16)]); 
				svst1_ver_za32(0, 13, p32_all, &buffer_m1[0 + (13*16)]); 
				svst1_ver_za32(0, 14, p32_all, &buffer_m1[0 + (14*16)]); 
				svst1_ver_za32(0, 15, p32_all, &buffer_m1[0 + (15*16)]); 
				svst1_ver_za32(1, 0, p32_all, &buffer_m1[0 + (1*16*16)]); 
				svst1_ver_za32(1, 1, p32_all, &buffer_m1[0 + (1*16+1*16*16)]); 
				svst1_ver_za32(1, 2, p32_all, &buffer_m1[0 + (2*16+1*16*16)]); 
				svst1_ver_za32(1, 3, p32_all, &buffer_m1[0 + (3*16+1*16*16)]); 
				svst1_ver_za32(1, 4, p32_all, &buffer_m1[0 + (4*16+1*16*16)]); 
				svst1_ver_za32(1, 5, p32_all, &buffer_m1[0 + (5*16+1*16*16)]); 
				svst1_ver_za32(1, 6, p32_all, &buffer_m1[0 + (6*16+1*16*16)]); 
				svst1_ver_za32(1, 7, p32_all, &buffer_m1[0 + (7*16+1*16*16)]); 
				svst1_ver_za32(1, 8, p32_all, &buffer_m1[0 + (8*16+1*16*16)]); 
				svst1_ver_za32(1, 9, p32_all, &buffer_m1[0 + (9*16+1*16*16)]); 
				svst1_ver_za32(1, 10, p32_all, &buffer_m1[0 + (10*16+1*16*16)]); 
				svst1_ver_za32(1, 11, p32_all, &buffer_m1[0 + (11*16+1*16*16)]); 
				svst1_ver_za32(1, 12, p32_all, &buffer_m1[0 + (12*16+1*16*16)]); 
				svst1_ver_za32(1, 13, p32_all, &buffer_m1[0 + (13*16+1*16*16)]); 
				svst1_ver_za32(1, 14, p32_all, &buffer_m1[0 + (14*16+1*16*16)]); 
				svst1_ver_za32(1, 15, p32_all, &buffer_m1[0 + (15*16+1*16*16)]); 
				svst1_ver_za32(2, 0, p32_all, &buffer_m1[0 + (2*16*16)]); 
				svst1_ver_za32(2, 1, p32_all, &buffer_m1[0 + (1*16+2*16*16)]); 
				svst1_ver_za32(2, 2, p32_all, &buffer_m1[0 + (2*16+2*16*16)]); 
				svst1_ver_za32(2, 3, p32_all, &buffer_m1[0 + (3*16+2*16*16)]); 
				svst1_ver_za32(2, 4, p32_all, &buffer_m1[0 + (4*16+2*16*16)]); 
				svst1_ver_za32(2, 5, p32_all, &buffer_m1[0 + (5*16+2*16*16)]); 
				svst1_ver_za32(2, 6, p32_all, &buffer_m1[0 + (6*16+2*16*16)]); 
				svst1_ver_za32(2, 7, p32_all, &buffer_m1[0 + (7*16+2*16*16)]); 
				svst1_ver_za32(2, 8, p32_all, &buffer_m1[0 + (8*16+2*16*16)]); 
				svst1_ver_za32(2, 9, p32_all, &buffer_m1[0 + (9*16+2*16*16)]); 
				svst1_ver_za32(2, 10, p32_all, &buffer_m1[0 + (10*16+2*16*16)]); 
				svst1_ver_za32(2, 11, p32_all, &buffer_m1[0 + (11*16+2*16*16)]); 
				svst1_ver_za32(2, 12, p32_all, &buffer_m1[0 + (12*16+2*16*16)]); 
				svst1_ver_za32(2, 13, p32_all, &buffer_m1[0 + (13*16+2*16*16)]); 
				svst1_ver_za32(2, 14, p32_all, &buffer_m1[0 + (14*16+2*16*16)]); 
				svst1_ver_za32(2, 15, p32_all, &buffer_m1[0 + (15*16+2*16*16)]); 
				svst1_ver_za32(3, 0, p32_all, &buffer_m1[0 + (3*16*16)]); 
				svst1_ver_za32(3, 1, p32_all, &buffer_m1[0 + (1*16+3*16*16)]); 
				svst1_ver_za32(3, 2, p32_all, &buffer_m1[0 + (2*16+3*16*16)]); 
				svst1_ver_za32(3, 3, p32_all, &buffer_m1[0 + (3*16+3*16*16)]); 
				svst1_ver_za32(3, 4, p32_all, &buffer_m1[0 + (4*16+3*16*16)]); 
				svst1_ver_za32(3, 5, p32_all, &buffer_m1[0 + (5*16+3*16*16)]); 
				svst1_ver_za32(3, 6, p32_all, &buffer_m1[0 + (6*16+3*16*16)]); 
				svst1_ver_za32(3, 7, p32_all, &buffer_m1[0 + (7*16+3*16*16)]); 
				svst1_ver_za32(3, 8, p32_all, &buffer_m1[0 + (8*16+3*16*16)]); 
				svst1_ver_za32(3, 9, p32_all, &buffer_m1[0 + (9*16+3*16*16)]); 
				svst1_ver_za32(3, 10, p32_all, &buffer_m1[0 + (10*16+3*16*16)]); 
				svst1_ver_za32(3, 11, p32_all, &buffer_m1[0 + (11*16+3*16*16)]); 
				svst1_ver_za32(3, 12, p32_all, &buffer_m1[0 + (12*16+3*16*16)]); 
				svst1_ver_za32(3, 13, p32_all, &buffer_m1[0 + (13*16+3*16*16)]); 
				svst1_ver_za32(3, 14, p32_all, &buffer_m1[0 + (14*16+3*16*16)]); 
				svst1_ver_za32(3, 15, p32_all, &buffer_m1[0 + (15*16+3*16*16)]); 
				// loading from grid 
				mask_x_0 = svwhilelt_b32(0, ker_size_x + 4); 
				svld1_hor_za32(0, 0, mask_x_0, &ptr_src[0 + 0]); 
				svld1_hor_za32(0, 1, mask_x_0, &ptr_src[0 + (1*16)]); 
				svld1_hor_za32(0, 2, mask_x_0, &ptr_src[0 + (2*16)]); 
				svld1_hor_za32(0, 3, mask_x_0, &ptr_src[0 + (3*16)]); 
				svld1_hor_za32(0, 4, mask_x_0, &ptr_src[0 + (1*sy)]); 
				svld1_hor_za32(0, 5, mask_x_0, &ptr_src[0 + (1*sy+1*16)]); 
				svld1_hor_za32(0, 6, mask_x_0, &ptr_src[0 + (1*sy+2*16)]); 
				svld1_hor_za32(0, 7, mask_x_0, &ptr_src[0 + (1*sy+3*16)]); 
				svld1_hor_za32(0, 8, mask_x_0, &ptr_src[0 + (2*sy)]); 
				svld1_hor_za32(0, 9, mask_x_0, &ptr_src[0 + (2*sy+1*16)]); 
				svld1_hor_za32(0, 10, mask_x_0, &ptr_src[0 + (2*sy+2*16)]); 
				svld1_hor_za32(0, 11, mask_x_0, &ptr_src[0 + (2*sy+3*16)]); 
				svld1_hor_za32(0, 12, mask_x_0, &ptr_src[0 + (3*sy)]); 
				svld1_hor_za32(0, 13, mask_x_0, &ptr_src[0 + (3*sy+1*16)]); 
				svld1_hor_za32(0, 14, mask_x_0, &ptr_src[0 + (3*sy+2*16)]); 
				svld1_hor_za32(0, 15, mask_x_0, &ptr_src[0 + (3*sy+3*16)]); 
				svld1_hor_za32(1, 0, mask_x_0, &ptr_src[0 + (1*16*4)]); 
				svld1_hor_za32(1, 1, mask_x_0, &ptr_src[0 + (1*16+1*16*4)]); 
				svld1_hor_za32(1, 2, mask_x_0, &ptr_src[0 + (2*16+1*16*4)]); 
				svld1_hor_za32(1, 3, mask_x_0, &ptr_src[0 + (3*16+1*16*4)]); 
				svld1_hor_za32(1, 4, mask_x_0, &ptr_src[0 + (1*sy+1*16*4)]); 
				svld1_hor_za32(1, 5, mask_x_0, &ptr_src[0 + (1*sy+1*16+1*16*4)]); 
				svld1_hor_za32(1, 6, mask_x_0, &ptr_src[0 + (1*sy+2*16+1*16*4)]); 
				svld1_hor_za32(1, 7, mask_x_0, &ptr_src[0 + (1*sy+3*16+1*16*4)]); 
				svld1_hor_za32(1, 8, mask_x_0, &ptr_src[0 + (2*sy+1*16*4)]); 
				svld1_hor_za32(1, 9, mask_x_0, &ptr_src[0 + (2*sy+1*16+1*16*4)]); 
				svld1_hor_za32(1, 10, mask_x_0, &ptr_src[0 + (2*sy+2*16+1*16*4)]); 
				svld1_hor_za32(1, 11, mask_x_0, &ptr_src[0 + (2*sy+3*16+1*16*4)]); 
				svld1_hor_za32(1, 12, mask_x_0, &ptr_src[0 + (3*sy+1*16*4)]); 
				svld1_hor_za32(1, 13, mask_x_0, &ptr_src[0 + (3*sy+1*16+1*16*4)]); 
				svld1_hor_za32(1, 14, mask_x_0, &ptr_src[0 + (3*sy+2*16+1*16*4)]); 
				svld1_hor_za32(1, 15, mask_x_0, &ptr_src[0 + (3*sy+3*16+1*16*4)]); 
				svld1_hor_za32(2, 0, mask_x_0, &ptr_src[0 + (2*16*4)]); 
				svld1_hor_za32(2, 1, mask_x_0, &ptr_src[0 + (1*16+2*16*4)]); 
				svld1_hor_za32(2, 2, mask_x_0, &ptr_src[0 + (2*16+2*16*4)]); 
				svld1_hor_za32(2, 3, mask_x_0, &ptr_src[0 + (3*16+2*16*4)]); 
				svld1_hor_za32(2, 4, mask_x_0, &ptr_src[0 + (1*sy+2*16*4)]); 
				svld1_hor_za32(2, 5, mask_x_0, &ptr_src[0 + (1*sy+1*16+2*16*4)]); 
				svld1_hor_za32(2, 6, mask_x_0, &ptr_src[0 + (1*sy+2*16+2*16*4)]); 
				svld1_hor_za32(2, 7, mask_x_0, &ptr_src[0 + (1*sy+3*16+2*16*4)]); 
				svld1_hor_za32(2, 8, mask_x_0, &ptr_src[0 + (2*sy+2*16*4)]); 
				svld1_hor_za32(2, 9, mask_x_0, &ptr_src[0 + (2*sy+1*16+2*16*4)]); 
				svld1_hor_za32(2, 10, mask_x_0, &ptr_src[0 + (2*sy+2*16+2*16*4)]); 
				svld1_hor_za32(2, 11, mask_x_0, &ptr_src[0 + (2*sy+3*16+2*16*4)]); 
				svld1_hor_za32(2, 12, mask_x_0, &ptr_src[0 + (3*sy+2*16*4)]); 
				svld1_hor_za32(2, 13, mask_x_0, &ptr_src[0 + (3*sy+1*16+2*16*4)]); 
				svld1_hor_za32(2, 14, mask_x_0, &ptr_src[0 + (3*sy+2*16+2*16*4)]); 
				svld1_hor_za32(2, 15, mask_x_0, &ptr_src[0 + (3*sy+3*16+2*16*4)]); 
				svld1_hor_za32(3, 0, mask_x_0, &ptr_src[0 + (3*16*4)]); 
				svld1_hor_za32(3, 1, mask_x_0, &ptr_src[0 + (1*16+3*16*4)]); 
				svld1_hor_za32(3, 2, mask_x_0, &ptr_src[0 + (2*16+3*16*4)]); 
				svld1_hor_za32(3, 3, mask_x_0, &ptr_src[0 + (3*16+3*16*4)]); 
				svld1_hor_za32(3, 4, mask_x_0, &ptr_src[0 + (1*sy+3*16*4)]); 
				svld1_hor_za32(3, 5, mask_x_0, &ptr_src[0 + (1*sy+1*16+3*16*4)]); 
				svld1_hor_za32(3, 6, mask_x_0, &ptr_src[0 + (1*sy+2*16+3*16*4)]); 
				svld1_hor_za32(3, 7, mask_x_0, &ptr_src[0 + (1*sy+3*16+3*16*4)]); 
				svld1_hor_za32(3, 8, mask_x_0, &ptr_src[0 + (2*sy+3*16*4)]); 
				svld1_hor_za32(3, 9, mask_x_0, &ptr_src[0 + (2*sy+1*16+3*16*4)]); 
				svld1_hor_za32(3, 10, mask_x_0, &ptr_src[0 + (2*sy+2*16+3*16*4)]); 
				svld1_hor_za32(3, 11, mask_x_0, &ptr_src[0 + (2*sy+3*16+3*16*4)]); 
				svld1_hor_za32(3, 12, mask_x_0, &ptr_src[0 + (3*sy+3*16*4)]); 
				svld1_hor_za32(3, 13, mask_x_0, &ptr_src[0 + (3*sy+1*16+3*16*4)]); 
				svld1_hor_za32(3, 14, mask_x_0, &ptr_src[0 + (3*sy+2*16+3*16*4)]); 
				svld1_hor_za32(3, 15, mask_x_0, &ptr_src[0 + (3*sy+3*16+3*16*4)]); 
				//tranpose and store back to grid
				svst1_ver_za32(0, 0, p32_all, &buffer_0[0 + 0]); 
				svst1_ver_za32(0, 1, p32_all, &buffer_0[0 + (1*16)]); 
				svst1_ver_za32(0, 2, p32_all, &buffer_0[0 + (2*16)]); 
				svst1_ver_za32(0, 3, p32_all, &buffer_0[0 + (3*16)]); 
				svst1_ver_za32(0, 4, p32_all, &buffer_0[0 + (4*16)]); 
				svst1_ver_za32(0, 5, p32_all, &buffer_0[0 + (5*16)]); 
				svst1_ver_za32(0, 6, p32_all, &buffer_0[0 + (6*16)]); 
				svst1_ver_za32(0, 7, p32_all, &buffer_0[0 + (7*16)]); 
				svst1_ver_za32(0, 8, p32_all, &buffer_0[0 + (8*16)]); 
				svst1_ver_za32(0, 9, p32_all, &buffer_0[0 + (9*16)]); 
				svst1_ver_za32(0, 10, p32_all, &buffer_0[0 + (10*16)]); 
				svst1_ver_za32(0, 11, p32_all, &buffer_0[0 + (11*16)]); 
				svst1_ver_za32(0, 12, p32_all, &buffer_0[0 + (12*16)]); 
				svst1_ver_za32(0, 13, p32_all, &buffer_0[0 + (13*16)]); 
				svst1_ver_za32(0, 14, p32_all, &buffer_0[0 + (14*16)]); 
				svst1_ver_za32(0, 15, p32_all, &buffer_0[0 + (15*16)]); 
				svst1_ver_za32(1, 0, p32_all, &buffer_0[0 + (1*16*16)]); 
				svst1_ver_za32(1, 1, p32_all, &buffer_0[0 + (1*16+1*16*16)]); 
				svst1_ver_za32(1, 2, p32_all, &buffer_0[0 + (2*16+1*16*16)]); 
				svst1_ver_za32(1, 3, p32_all, &buffer_0[0 + (3*16+1*16*16)]); 
				svst1_ver_za32(1, 4, p32_all, &buffer_0[0 + (4*16+1*16*16)]); 
				svst1_ver_za32(1, 5, p32_all, &buffer_0[0 + (5*16+1*16*16)]); 
				svst1_ver_za32(1, 6, p32_all, &buffer_0[0 + (6*16+1*16*16)]); 
				svst1_ver_za32(1, 7, p32_all, &buffer_0[0 + (7*16+1*16*16)]); 
				svst1_ver_za32(1, 8, p32_all, &buffer_0[0 + (8*16+1*16*16)]); 
				svst1_ver_za32(1, 9, p32_all, &buffer_0[0 + (9*16+1*16*16)]); 
				svst1_ver_za32(1, 10, p32_all, &buffer_0[0 + (10*16+1*16*16)]); 
				svst1_ver_za32(1, 11, p32_all, &buffer_0[0 + (11*16+1*16*16)]); 
				svst1_ver_za32(1, 12, p32_all, &buffer_0[0 + (12*16+1*16*16)]); 
				svst1_ver_za32(1, 13, p32_all, &buffer_0[0 + (13*16+1*16*16)]); 
				svst1_ver_za32(1, 14, p32_all, &buffer_0[0 + (14*16+1*16*16)]); 
				svst1_ver_za32(1, 15, p32_all, &buffer_0[0 + (15*16+1*16*16)]); 
				svst1_ver_za32(2, 0, p32_all, &buffer_0[0 + (2*16*16)]); 
				svst1_ver_za32(2, 1, p32_all, &buffer_0[0 + (1*16+2*16*16)]); 
				svst1_ver_za32(2, 2, p32_all, &buffer_0[0 + (2*16+2*16*16)]); 
				svst1_ver_za32(2, 3, p32_all, &buffer_0[0 + (3*16+2*16*16)]); 
				svst1_ver_za32(2, 4, p32_all, &buffer_0[0 + (4*16+2*16*16)]); 
				svst1_ver_za32(2, 5, p32_all, &buffer_0[0 + (5*16+2*16*16)]); 
				svst1_ver_za32(2, 6, p32_all, &buffer_0[0 + (6*16+2*16*16)]); 
				svst1_ver_za32(2, 7, p32_all, &buffer_0[0 + (7*16+2*16*16)]); 
				svst1_ver_za32(2, 8, p32_all, &buffer_0[0 + (8*16+2*16*16)]); 
				svst1_ver_za32(2, 9, p32_all, &buffer_0[0 + (9*16+2*16*16)]); 
				svst1_ver_za32(2, 10, p32_all, &buffer_0[0 + (10*16+2*16*16)]); 
				svst1_ver_za32(2, 11, p32_all, &buffer_0[0 + (11*16+2*16*16)]); 
				svst1_ver_za32(2, 12, p32_all, &buffer_0[0 + (12*16+2*16*16)]); 
				svst1_ver_za32(2, 13, p32_all, &buffer_0[0 + (13*16+2*16*16)]); 
				svst1_ver_za32(2, 14, p32_all, &buffer_0[0 + (14*16+2*16*16)]); 
				svst1_ver_za32(2, 15, p32_all, &buffer_0[0 + (15*16+2*16*16)]); 
				svst1_ver_za32(3, 0, p32_all, &buffer_0[0 + (3*16*16)]); 
				svst1_ver_za32(3, 1, p32_all, &buffer_0[0 + (1*16+3*16*16)]); 
				svst1_ver_za32(3, 2, p32_all, &buffer_0[0 + (2*16+3*16*16)]); 
				svst1_ver_za32(3, 3, p32_all, &buffer_0[0 + (3*16+3*16*16)]); 
				svst1_ver_za32(3, 4, p32_all, &buffer_0[0 + (4*16+3*16*16)]); 
				svst1_ver_za32(3, 5, p32_all, &buffer_0[0 + (5*16+3*16*16)]); 
				svst1_ver_za32(3, 6, p32_all, &buffer_0[0 + (6*16+3*16*16)]); 
				svst1_ver_za32(3, 7, p32_all, &buffer_0[0 + (7*16+3*16*16)]); 
				svst1_ver_za32(3, 8, p32_all, &buffer_0[0 + (8*16+3*16*16)]); 
				svst1_ver_za32(3, 9, p32_all, &buffer_0[0 + (9*16+3*16*16)]); 
				svst1_ver_za32(3, 10, p32_all, &buffer_0[0 + (10*16+3*16*16)]); 
				svst1_ver_za32(3, 11, p32_all, &buffer_0[0 + (11*16+3*16*16)]); 
				svst1_ver_za32(3, 12, p32_all, &buffer_0[0 + (12*16+3*16*16)]); 
				svst1_ver_za32(3, 13, p32_all, &buffer_0[0 + (13*16+3*16*16)]); 
				svst1_ver_za32(3, 14, p32_all, &buffer_0[0 + (14*16+3*16*16)]); 
				svst1_ver_za32(3, 15, p32_all, &buffer_0[0 + (15*16+3*16*16)]); 
				...
				for(int vx = 0; vx < ker_size_x; vx += 16) {
					...
					ptr_m1 = (buffer_m1 + 192); ptr_0 = buffer_0; ptr_1 = buffer_1;
					// loading from grid 
					...
					svld1_hor_za32(3, 15, mask_x_0, &(ptr_src + (1*16*4*4))[0 + (3*sy+3*16+3*16*4)]); 
					//tranpose and store back to grid
					svst1_ver_za32(0, 0, p32_all, &buffer_1[0 + 0]); 
					svst1_ver_za32(0, 1, p32_all, &buffer_1[0 + (1*16)]); 
					svst1_ver_za32(0, 2, p32_all, &buffer_1[0 + (2*16)]); 
					svst1_ver_za32(0, 3, p32_all, &buffer_1[0 + (3*16)]); 
					svst1_ver_za32(0, 4, p32_all, &buffer_1[0 + (4*16)]); 
					svst1_ver_za32(0, 5, p32_all, &buffer_1[0 + (5*16)]); 
					svst1_ver_za32(0, 6, p32_all, &buffer_1[0 + (6*16)]); 
					svst1_ver_za32(0, 7, p32_all, &buffer_1[0 + (7*16)]); 
					svst1_ver_za32(0, 8, p32_all, &buffer_1[0 + (8*16)]); 
					svst1_ver_za32(0, 9, p32_all, &buffer_1[0 + (9*16)]); 
					svst1_ver_za32(0, 10, p32_all, &buffer_1[0 + (10*16)]); 
					svst1_ver_za32(0, 11, p32_all, &buffer_1[0 + (11*16)]); 
					svst1_ver_za32(0, 12, p32_all, &buffer_1[0 + (12*16)]); 
					svst1_ver_za32(0, 13, p32_all, &buffer_1[0 + (13*16)]); 
					svst1_ver_za32(0, 14, p32_all, &buffer_1[0 + (14*16)]); 
					svst1_ver_za32(0, 15, p32_all, &buffer_1[0 + (15*16)]); 
					svst1_ver_za32(1, 0, p32_all, &buffer_1[0 + (1*16*16)]); 
					svst1_ver_za32(1, 1, p32_all, &buffer_1[0 + (1*16+1*16*16)]); 
					svst1_ver_za32(1, 2, p32_all, &buffer_1[0 + (2*16+1*16*16)]); 
					svst1_ver_za32(1, 3, p32_all, &buffer_1[0 + (3*16+1*16*16)]); 
					svst1_ver_za32(1, 4, p32_all, &buffer_1[0 + (4*16+1*16*16)]); 
					svst1_ver_za32(1, 5, p32_all, &buffer_1[0 + (5*16+1*16*16)]); 
					svst1_ver_za32(1, 6, p32_all, &buffer_1[0 + (6*16+1*16*16)]); 
					svst1_ver_za32(1, 7, p32_all, &buffer_1[0 + (7*16+1*16*16)]); 
					svst1_ver_za32(1, 8, p32_all, &buffer_1[0 + (8*16+1*16*16)]); 
					svst1_ver_za32(1, 9, p32_all, &buffer_1[0 + (9*16+1*16*16)]); 
					svst1_ver_za32(1, 10, p32_all, &buffer_1[0 + (10*16+1*16*16)]); 
					svst1_ver_za32(1, 11, p32_all, &buffer_1[0 + (11*16+1*16*16)]); 
					svst1_ver_za32(1, 12, p32_all, &buffer_1[0 + (12*16+1*16*16)]); 
					svst1_ver_za32(1, 13, p32_all, &buffer_1[0 + (13*16+1*16*16)]); 
					svst1_ver_za32(1, 14, p32_all, &buffer_1[0 + (14*16+1*16*16)]); 
					svst1_ver_za32(1, 15, p32_all, &buffer_1[0 + (15*16+1*16*16)]); 
					svst1_ver_za32(2, 0, p32_all, &buffer_1[0 + (2*16*16)]); 
					svst1_ver_za32(2, 1, p32_all, &buffer_1[0 + (1*16+2*16*16)]); 
					svst1_ver_za32(2, 2, p32_all, &buffer_1[0 + (2*16+2*16*16)]); 
					svst1_ver_za32(2, 3, p32_all, &buffer_1[0 + (3*16+2*16*16)]); 
					svst1_ver_za32(2, 4, p32_all, &buffer_1[0 + (4*16+2*16*16)]); 
					svst1_ver_za32(2, 5, p32_all, &buffer_1[0 + (5*16+2*16*16)]); 
					svst1_ver_za32(2, 6, p32_all, &buffer_1[0 + (6*16+2*16*16)]); 
					svst1_ver_za32(2, 7, p32_all, &buffer_1[0 + (7*16+2*16*16)]); 
					svst1_ver_za32(2, 8, p32_all, &buffer_1[0 + (8*16+2*16*16)]); 
					svst1_ver_za32(2, 9, p32_all, &buffer_1[0 + (9*16+2*16*16)]); 
					svst1_ver_za32(2, 10, p32_all, &buffer_1[0 + (10*16+2*16*16)]); 
					svst1_ver_za32(2, 11, p32_all, &buffer_1[0 + (11*16+2*16*16)]); 
					svst1_ver_za32(2, 12, p32_all, &buffer_1[0 + (12*16+2*16*16)]); 
					svst1_ver_za32(2, 13, p32_all, &buffer_1[0 + (13*16+2*16*16)]); 
					svst1_ver_za32(2, 14, p32_all, &buffer_1[0 + (14*16+2*16*16)]); 
					svst1_ver_za32(2, 15, p32_all, &buffer_1[0 + (15*16+2*16*16)]); 
					svst1_ver_za32(3, 0, p32_all, &buffer_1[0 + (3*16*16)]); 
					svst1_ver_za32(3, 1, p32_all, &buffer_1[0 + (1*16+3*16*16)]); 
					svst1_ver_za32(3, 2, p32_all, &buffer_1[0 + (2*16+3*16*16)]); 
					svst1_ver_za32(3, 3, p32_all, &buffer_1[0 + (3*16+3*16*16)]); 
					svst1_ver_za32(3, 4, p32_all, &buffer_1[0 + (4*16+3*16*16)]); 
					svst1_ver_za32(3, 5, p32_all, &buffer_1[0 + (5*16+3*16*16)]); 
					svst1_ver_za32(3, 6, p32_all, &buffer_1[0 + (6*16+3*16*16)]); 
					svst1_ver_za32(3, 7, p32_all, &buffer_1[0 + (7*16+3*16*16)]); 
					svst1_ver_za32(3, 8, p32_all, &buffer_1[0 + (8*16+3*16*16)]); 
					svst1_ver_za32(3, 9, p32_all, &buffer_1[0 + (9*16+3*16*16)]); 
					svst1_ver_za32(3, 10, p32_all, &buffer_1[0 + (10*16+3*16*16)]); 
					svst1_ver_za32(3, 11, p32_all, &buffer_1[0 + (11*16+3*16*16)]); 
					svst1_ver_za32(3, 12, p32_all, &buffer_1[0 + (12*16+3*16*16)]); 
					svst1_ver_za32(3, 13, p32_all, &buffer_1[0 + (13*16+3*16*16)]); 
					svst1_ver_za32(3, 14, p32_all, &buffer_1[0 + (14*16+3*16*16)]); 
					svst1_ver_za32(3, 15, p32_all, &buffer_1[0 + (15*16+3*16*16)]); 
				...
				mask_x_0 = svwhilelt_b32(0, ker_size_x + 4); 
				mask_z = svdup_b32(0 < ker_size_z - vz); 
				mask_y = svdup_b32(0 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(0, 0, mask_xyz, &ptr_src[0 + 0]); 
				mask_y = svdup_b32(1 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(0, 1, mask_xyz, &ptr_src[0 + (1*16)]); 
				mask_y = svdup_b32(2 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(0, 2, mask_xyz, &ptr_src[0 + (2*16)]); 
				mask_y = svdup_b32(3 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(0, 3, mask_xyz, &ptr_src[0 + (3*16)]); 
				mask_y = svdup_b32(4 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(0, 4, mask_xyz, &ptr_src[0 + (1*sy)]); 
				mask_y = svdup_b32(5 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(0, 5, mask_xyz, &ptr_src[0 + (1*sy+1*16)]); 
				mask_y = svdup_b32(6 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(0, 6, mask_xyz, &ptr_src[0 + (1*sy+2*16)]); 
				mask_y = svdup_b32(7 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(0, 7, mask_xyz, &ptr_src[0 + (1*sy+3*16)]); 
				mask_y = svdup_b32(8 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(0, 8, mask_xyz, &ptr_src[0 + (2*sy)]); 
				mask_y = svdup_b32(9 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(0, 9, mask_xyz, &ptr_src[0 + (2*sy+1*16)]); 
				mask_y = svdup_b32(10 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(0, 10, mask_xyz, &ptr_src[0 + (2*sy+2*16)]); 
				mask_y = svdup_b32(11 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(0, 11, mask_xyz, &ptr_src[0 + (2*sy+3*16)]); 
				mask_y = svdup_b32(12 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(0, 12, mask_xyz, &ptr_src[0 + (3*sy)]); 
				mask_y = svdup_b32(13 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(0, 13, mask_xyz, &ptr_src[0 + (3*sy+1*16)]); 
				mask_y = svdup_b32(14 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(0, 14, mask_xyz, &ptr_src[0 + (3*sy+2*16)]); 
				mask_y = svdup_b32(15 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(0, 15, mask_xyz, &ptr_src[0 + (3*sy+3*16)]); 
				mask_z = svdup_b32(1 < ker_size_z - vz); 
				mask_y = svdup_b32(0 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(1, 0, mask_xyz, &ptr_src[0 + (1*16*4)]); 
				mask_y = svdup_b32(1 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(1, 1, mask_xyz, &ptr_src[0 + (1*16+1*16*4)]); 
				mask_y = svdup_b32(2 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(1, 2, mask_xyz, &ptr_src[0 + (2*16+1*16*4)]); 
				mask_y = svdup_b32(3 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(1, 3, mask_xyz, &ptr_src[0 + (3*16+1*16*4)]); 
				mask_y = svdup_b32(4 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(1, 4, mask_xyz, &ptr_src[0 + (1*sy+1*16*4)]); 
				mask_y = svdup_b32(5 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(1, 5, mask_xyz, &ptr_src[0 + (1*sy+1*16+1*16*4)]); 
				mask_y = svdup_b32(6 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(1, 6, mask_xyz, &ptr_src[0 + (1*sy+2*16+1*16*4)]); 
				mask_y = svdup_b32(7 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(1, 7, mask_xyz, &ptr_src[0 + (1*sy+3*16+1*16*4)]); 
				mask_y = svdup_b32(8 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(1, 8, mask_xyz, &ptr_src[0 + (2*sy+1*16*4)]); 
				mask_y = svdup_b32(9 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(1, 9, mask_xyz, &ptr_src[0 + (2*sy+1*16+1*16*4)]); 
				mask_y = svdup_b32(10 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(1, 10, mask_xyz, &ptr_src[0 + (2*sy+2*16+1*16*4)]); 
				mask_y = svdup_b32(11 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(1, 11, mask_xyz, &ptr_src[0 + (2*sy+3*16+1*16*4)]); 
				mask_y = svdup_b32(12 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(1, 12, mask_xyz, &ptr_src[0 + (3*sy+1*16*4)]); 
				mask_y = svdup_b32(13 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(1, 13, mask_xyz, &ptr_src[0 + (3*sy+1*16+1*16*4)]); 
				mask_y = svdup_b32(14 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(1, 14, mask_xyz, &ptr_src[0 + (3*sy+2*16+1*16*4)]); 
				mask_y = svdup_b32(15 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(1, 15, mask_xyz, &ptr_src[0 + (3*sy+3*16+1*16*4)]); 
				mask_z = svdup_b32(2 < ker_size_z - vz); 
				mask_y = svdup_b32(0 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(2, 0, mask_xyz, &ptr_src[0 + (2*16*4)]); 
				mask_y = svdup_b32(1 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(2, 1, mask_xyz, &ptr_src[0 + (1*16+2*16*4)]); 
				mask_y = svdup_b32(2 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(2, 2, mask_xyz, &ptr_src[0 + (2*16+2*16*4)]); 
				mask_y = svdup_b32(3 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(2, 3, mask_xyz, &ptr_src[0 + (3*16+2*16*4)]); 
				mask_y = svdup_b32(4 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(2, 4, mask_xyz, &ptr_src[0 + (1*sy+2*16*4)]); 
				mask_y = svdup_b32(5 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(2, 5, mask_xyz, &ptr_src[0 + (1*sy+1*16+2*16*4)]); 
				mask_y = svdup_b32(6 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(2, 6, mask_xyz, &ptr_src[0 + (1*sy+2*16+2*16*4)]); 
				mask_y = svdup_b32(7 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(2, 7, mask_xyz, &ptr_src[0 + (1*sy+3*16+2*16*4)]); 
				mask_y = svdup_b32(8 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(2, 8, mask_xyz, &ptr_src[0 + (2*sy+2*16*4)]); 
				mask_y = svdup_b32(9 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(2, 9, mask_xyz, &ptr_src[0 + (2*sy+1*16+2*16*4)]); 
				mask_y = svdup_b32(10 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(2, 10, mask_xyz, &ptr_src[0 + (2*sy+2*16+2*16*4)]); 
				mask_y = svdup_b32(11 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(2, 11, mask_xyz, &ptr_src[0 + (2*sy+3*16+2*16*4)]); 
				mask_y = svdup_b32(12 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(2, 12, mask_xyz, &ptr_src[0 + (3*sy+2*16*4)]); 
				mask_y = svdup_b32(13 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(2, 13, mask_xyz, &ptr_src[0 + (3*sy+1*16+2*16*4)]); 
				mask_y = svdup_b32(14 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(2, 14, mask_xyz, &ptr_src[0 + (3*sy+2*16+2*16*4)]); 
				mask_y = svdup_b32(15 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(2, 15, mask_xyz, &ptr_src[0 + (3*sy+3*16+2*16*4)]); 
				mask_z = svdup_b32(3 < ker_size_z - vz); 
				mask_y = svdup_b32(0 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(3, 0, mask_xyz, &ptr_src[0 + (3*16*4)]); 
				mask_y = svdup_b32(1 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(3, 1, mask_xyz, &ptr_src[0 + (1*16+3*16*4)]); 
				mask_y = svdup_b32(2 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(3, 2, mask_xyz, &ptr_src[0 + (2*16+3*16*4)]); 
				mask_y = svdup_b32(3 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(3, 3, mask_xyz, &ptr_src[0 + (3*16+3*16*4)]); 
				mask_y = svdup_b32(4 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(3, 4, mask_xyz, &ptr_src[0 + (1*sy+3*16*4)]); 
				mask_y = svdup_b32(5 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(3, 5, mask_xyz, &ptr_src[0 + (1*sy+1*16+3*16*4)]); 
				mask_y = svdup_b32(6 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(3, 6, mask_xyz, &ptr_src[0 + (1*sy+2*16+3*16*4)]); 
				mask_y = svdup_b32(7 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(3, 7, mask_xyz, &ptr_src[0 + (1*sy+3*16+3*16*4)]); 
				mask_y = svdup_b32(8 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(3, 8, mask_xyz, &ptr_src[0 + (2*sy+3*16*4)]); 
				mask_y = svdup_b32(9 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(3, 9, mask_xyz, &ptr_src[0 + (2*sy+1*16+3*16*4)]); 
				mask_y = svdup_b32(10 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(3, 10, mask_xyz, &ptr_src[0 + (2*sy+2*16+3*16*4)]); 
				mask_y = svdup_b32(11 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(3, 11, mask_xyz, &ptr_src[0 + (2*sy+3*16+3*16*4)]); 
				mask_y = svdup_b32(12 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(3, 12, mask_xyz, &ptr_src[0 + (3*sy+3*16*4)]); 
				mask_y = svdup_b32(13 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(3, 13, mask_xyz, &ptr_src[0 + (3*sy+1*16+3*16*4)]); 
				mask_y = svdup_b32(14 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(3, 14, mask_xyz, &ptr_src[0 + (3*sy+2*16+3*16*4)]); 
				mask_y = svdup_b32(15 < ker_size_y - vy + 4); mask_yz = svand_z(p32_all, mask_y, mask_z); mask_xyz = svand_z(p32_all, mask_x_0, mask_yz); svld1_hor_za32(3, 15, mask_xyz, &ptr_src[0 + (3*sy+3*16+3*16*4)]); 
				//tranpose and store back to grid
				svst1_ver_za32(0, 0, p32_all, &buffer_0[0 + 0]); 
				svst1_ver_za32(0, 1, p32_all, &buffer_0[0 + (1*16)]); 
				svst1_ver_za32(0, 2, p32_all, &buffer_0[0 + (2*16)]); 
				...
				for(int vx = 0; vx < ker_size_x; vx += 16) {
					...
					alpha_vec_y = svinsr(alpha_vec_y, coef[0]); 
					mask_z = svdup_b32(0 < ker_size_z - vz); mask_yz = svand_z(p32_all, mask_z, mask_y); 
					...
					mask_z = svdup_b32(1 < ker_size_z - vz); mask_yz = svand_z(p32_all, mask_z, mask_y); 
					...
					mask_z = svdup_b32(2 < ker_size_z - vz); mask_yz = svand_z(p32_all, mask_z, mask_y); 
					...
					mask_z = svdup_b32(3 < ker_size_z - vz); mask_yz = svand_z(p32_all, mask_z, mask_y); 
